...
<body>
	...
	<div class="col-xs-12 padding0">
		<div class="text-center margin-top25 col-xs-12 padding0">
			<h1 class="label ct-demo-heading" id="headingInSll">Add Nodes in SLL</h1>
		</div>
			...
			<div class="col-xs-10 col-xs-offset-1 padding0" id="explanationDiv">
				<div class="col-xs-12 padding0">
					<div class="col-xs-5 padding0">
						...
						<div class="col-xs-12 padding0"><pre class="creamPreTab opacity00 col-xs-10 col-xs-offset-1" id="createMthd"></pre></div>
					</div>
