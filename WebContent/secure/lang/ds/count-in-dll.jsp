		...
		<div class='col-xs-12 padding00'>
			<div class="ct-box-main">
				<div class='text-center'>
					<h4 class='label ct-demo-heading' id='headingDiv'>Count() in DLL</h4>
				</div>
			</div>
				...
				<div class='col-xs-12 padding00'>
					<div class='col-xs-5 padding00'>
						<div class='col-xs-12 margin-top-15 padding00'>
							<div class='col-xs-12 box-border margin-top-25' id='animationDiv'>
			...
			<div class='col-xs-12 text-center'>
				<div class='buttons-div margin-top-20 text-center'>
					<span type="button" class="btn btn-warning opacity00" id="restartBtn">Restart</span>
				</div>	
			</div>
		</div>
	</div>
