		...
		$('.introjs-helperLayer').one('transitionend', function() {
			...
			case "algorithmStepsDiv" :
				...
				case 'Step1':
					...
					appendSteps(1);
					var text = '<ul><li>Let us take one temporary node <g>temp</g> and it can be initialized with the <g>first</g> value.</li>'
...
function checkTempNotEqNull() {
	...
	if ($('#tempVal').text() != 'NULL') {
		...
		$('.introjs-tooltiptext ul li:last').after('<li></li>');
		text = 'Here, the condition evaluates to <y>TRUE</y>, because <y>temp</y> is <y>not equal</y> to <y>NULL</y>. so first,'
...
function tempIsNull() {
	$('.introjs-tooltiptext ul li:last').after('<li></li>');
	text = 'Here, the condition evaluates to <y>false</y>, because <y>temp</y> is <y>equal</y> to <y>NULL</y>.';
	typing('.introjs-tooltiptext ul li:last', text, function() {
		$('.introjs-tooltiptext').scrollTo('ul li:last', 500);
		$('.introjs-tooltiptext ul li:last').after('<li></li>');
