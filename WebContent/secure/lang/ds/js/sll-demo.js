...
function structDiv() {
	$('#structParent').empty();
	if (lang == 'c') {
		$('#structParent').append('<span id="structSpanParent"><span id="strcutSpan"><span class="ct-brown-color ct-css">struct</span> list {\n'
				+ '\t<span class="ct-green-color ct-css">int</span> data;\n'
				+ '\t<span class="ct-brown-color ct-css">struct</span> list *next;\n'
				+ '};</span>\n'
				+ '<span id="typeDefDec"><span class="ct-brown-color ct-css">typedef struct</span> list *<span class="ct-blue-color ct-css">node</span>;</span>\n'
				+ '<span id="nodeDec">node first = NULL;</span></span>');
	} else if (lang == 'cpp') {
		$('#structParent').append('<span id="structSpanParent"><span id="strcutSpan"><span class="ct-brown-color ct-css">struct</span> list {\n'
				+ '\t<span class="ct-green-color ct-css">int</span> data;\n'
				+ '\t<span class="ct-brown-color ct-css">struct</span> list *next;\n'
...
function addMainMethod() {
	...
	if (lang == 'c') {
		$("#mainFunctions").append('<span id="addMain"><span id="whilePrintStatmnt">printf("Enter elements up to -1 : ");</span>\n'
				+ '<span id="whileScan1">scanf("%d", &x);</span>\n'
				+ '<span id="addWhile">while (x != -1)</span> {\n'
				+ '\t<span id="trueCond">first = addNodes(first, x);</span>\n'
				+ '\t<span id="whileScan2">scanf("%d", &x);</span>\n}</span>');
	} else if (lang == 'cpp') {
		$("#mainFunctions").append('<span id="addMain"><span id="emptyMth">s.empty();</span>\n'
				+ '<span id="whilePrintStatmnt">cout << "Enter elements up to -1 : ";</span>\n'
				+ '<span id="whileScan1">cin >> x;</span>\n'
				+ '<span id="addWhile">while (x != -1)</span> {\n'
				+ '\t<span id="trueCond">s.addNodes(x);</span>\n'
				+ '\t<span id="whilePrintStatmnt1">cout << "Enter elements up to -1: "</span>\n'
				+ '\t<span id="whileScan2">cin >> x;</span>\n}</span></span>');
	}
...
function displayMainMethod() {
	if (lang == 'c') {
		...
		$("#mainFunctions").append('<span id="displayMain"><span id="displayIfElse">cout << "The elements in SLL are : ";</span>\n'
				+ '<span id="callTraverseList">s.traverseList();</span>\n</span>');
	}
}
...
function preInsertBeginMainMethod() {
	if (lang == 'c') {
		...
		$("#mainFunctions").append('<span id="insertAtBeginMain"><span id="insertAtBeginPrint">cout << "Enter any number : ";</span>\n'
				+ '<span id="insertAtBeginScan">cin >> x;</span>\n'
				+ '<span id="insertAtBeginFunction">s.insertAtBegin(x);</span></span>');
	}
}
...
function preInsertEndMainMethod() {
	if (lang == 'c') {
		...
		$("#mainFunctions").append('<span id="insertAtEndMain"><span id="insertAtEndPrintf">cout << "Enter any number : ";</span>\n'
				+ '<span id="insertAtEndScanf">cin >> x;</span>\n'
				+ '<span id="insertAtEndCall">s.insertAtEnd(x);</span></span>');
	}
...
function preInsertPositionMainMethod() {
	if (lang == 'c') {
		...
		$("#mainFunctions").append('<span id="insertAtPositionMain"><span id="insertPositionPosPrintf">cout << "Enter a position : ";</span>\n'
				+ '<span id="insertPositionPosScanf">cin >> pos;</span>\n'
				+ '<span id="insertPosPrintf">cout << "Enter an element : ";</span>\n'
				+ '<span id="insertPosScanf">cin >> x;</span>\n'
				+ '<span id="insertPosCall">s.insertAtPosition(pos, x);</span></span>');
	}
...
function preCountMainMethod() {
	if (lang == 'c') {
		...
		$("#mainFunctions").append('<span id="countMain" style="display: inline-block">cout << "The number of nodes in a SLL are : "\n\t\t\t\t'
				+ '<<  <span id="countMethod">s.count()</span> << "\\n";</span>');
	}
}
...
function preSearchMainMethod() {
	if (lang == 'c') {
		...
		$("#mainFunctions").append('<span id="searchElement"><span id="initVar">int x, pos;</span>\n'
				+ '<span id="printf1">cout << "Enter search element : ";</span>\n'
				+ '<span id="scanf1">cin >> x;</span>\n'
				+ '<span id="calSrhMethod">pos = <span id="callSearchMethod">s.searchPosOfEle(x);</span></span>\n'
				+ '<span id="ifConForSearch">if (<span id="IfPos">pos == 0</span>) {</span>\n'
				+ '\t<span id="printf2" style="display: inline-block">cout << "The given element " << x << "is"\n'
				+ '\t" not found in the given SLL\\n";</span>\n} else {\n'
				+ '\t<span id="printf3" style="display: inline-block">cout << "The given element " << x << "is"\n'
...
function preDeleteBeginMainMethod() {
	if (lang == 'c') {
		...
		$("#mainFunctions").append('<span id="deleteAtBeginElement"><span id="callDelAtBeginMethod">s.deleteAtBegin();</span></span>');	
...
function preDeleteEndMainMethod() {
	if (lang == 'c') {
		...
		$("#mainFunctions").append('<span id="deleteAtEndElement"><span id="callDelAtEndMethod">s.deleteAtEnd();</span></span>');
	}
...
function preDeletePositionMainMethod() {
	if (lang == 'c') {
		...
		$("#mainFunctions").append('<span id="deleteAtPositionElement">'
				+ '<span id="printfPos2">cout << "Enter position : ";</span>\n'
				+ '<span id="scanfPos2">cin >> pos;</span>\n'
				+ '<span id="callToPosDeleteFunction">s.deleteAtPosition(pos);</span></span>');
...
function preAddNodeMethod() {
	$('#parentPre').empty();//pending
	$("#parentPre").append('<span id="addNodeParent"><span id="addNodeMethod" class="hide"></span>'
						+ '<span id="insertAtEndMethod" class="hide"></span>\n'
						...
						+ '\t<span id="returnFrst"></span>\n}</span>');
	
	if (lang == "c") {
		$('#addNodeMethod').html('<span class="ct-blue-color ct-css">node</span>'
				+ ' <span class="ct-green-color ct-css">addNodes(node first, int x)</span> {');
		$('#returnFrst').text('return first;');
		
		$('#insertAtEndMethod').html('<span class="ct-blue-color ct-css">node</span>'
				+ ' <span class="ct-green-color ct-css">insertAtEnd(node first, int x)</span> {')
	} else if (lang == "cpp") {
		$('#addNodeMethod').html('<span class="ct-green-color ct-css">void Sll::</span>'
				+ 'addNodes(<span class="ct-green-color ct-css">int</span> x) {');
		
		$('#insertAtEndMethod').html('<span class="ct-green-color ct-css">void Sll::</span>'
				+ ' insertAtEnd(<span class="ct-green-color ct-css">int</span> x) {')
	}
}

function preDisplayMethod() {
	if (lang == 'c') {
		$("#parentPre").append('<span id="traverseParent">void <span class="ct-green-color ct-css">traverseList(node first)</span> {\n'
		...
		$("#parentPre").append('<span id="traverseParent"><span class="ct-green-color ct-css">void Sll::</span>traverseList() {\n'
				+ '\t<span id="traverseTemp">node temp = first;</span>\n'
				+ '\t<span id="traverseWhileCond">while (<span id="traverseWhileLoop">temp != NULL</span>) {</span>\n'
				+ '\t\t<span id="traverseWhileTrue">cout << temp -> data << " --> ";</span>\n'
				+ '\t\t<span id="traverseTempInc">temp = temp -> next;</span>\n\t}\n'
				+ '\t<span id="traverseWhileFalse">cout << "<span id="nullPrint">NULL\\n</span>";</span>\n}</span>');
	}
...
function preInsertBeginMethod() {
		if (lang == 'c') {
			$("#parentPre").append('<span id="insertAtBeginParent"><span class="ct-blue-color ct-css">node</span>'
					+ ' <span class="ct-green-color ct-css">insertAtBegin(node first, int x)</span> {\n'
			...
			$("#parentPre").append('<span id="insertAtBeginParent"><span class="ct-green-color ct-css">void Sll::</span>'
					+ ' insertAtBegin(<span class="ct-green-color ct-css">int</span> x) {\n'
					+ '\t<span id="insertBeginTempDec">node temp;</span>\n'
					+ '\t<span id="createCallBegin">temp = createNode();</span>\n'
					+ '\t<span id="tempDataBegin">temp -> data = x;</span>\n'
					+ '\t<span id="tempNextFirst">temp -> next = first;</span>\n'
...
function preInsertPositionMethod() {
	$("#parentPre").append('<span id="insertAtPositionParent"><span id="methodName"></span>\n'
						...
						+ '\t\t\t<span id="insertPosForIfReturn"></span>\n\t\t}\n'
						...
						+ '\t<span id="insertPosReturn"></span>\n}</span>');	
	if (lang == 'c') {
		$('#methodName').html('<span class="ct-blue-color ct-css">node</span>'
				+ ' <span class="ct-green-color ct-css">insertAtPosition(node first, int pos, int x)</span> {');
		$('#insertPosReturn, #zeroRetun, #insertPosForIfReturn').text('return first;');
		
		
	} else if (lang == 'cpp') {
		$('#methodName').html('<span class="ct-green-color ct-css">void Sll::</span>'
				+ ' insertAtPosition(<span class="ct-green-color ct-css">int</span> pos, <span class="ct-green-color ct-css">int</span> x) {');
	}
}

function preCountMethod() {
	if (lang == 'c') {
		$("#parentPre").append('<span id="countParent"><span class="ct-green-color ct-css">int</span> count(node first) {\n'
		...
		$("#parentPre").append('<span id="countParent"><span class="ct-green-color ct-css">int Sll::</span>count() {\n'
				+ '\t<span id="countTempDec">node temp = first;</span>\n'
				+ '\t<span id="countSumDec">int sum = 0;</span>\n'
				+ '\t<span id="countWhileCond">while (<span id="countCond">temp != NULL</span>) {\n'
				+ '\t\t<span id="countSumInc">sum++;</span>\n'
...
function preSearchMethod() {
	$("#parentPre").append('<span id="searchParent"><span id="searchText"></span> {\n'
	...
	if (lang == 'c') {
		$('#searchText').html('<span id="searchLogic">int'
				+ ' <span class="ct-green-color ct-css">searchPosOfEle(node first, int key)</span>');
	} else if (lang == 'cpp') {
		$('#searchText').html('<span id="searchLogic">void Sll::'
				+ ' <span class="ct-green-color ct-css">searchPosOfEle(int key)</span>');
	}
}

function preDeleteBeginMethod() {
	if (lang == 'c') {
		$("#parentPre").append('<span id="deleteAtBeginParent"><span id="deleteAtBeginLogic"><span class="ct-blue-color ct-css">node</span>'
		...
		$("#parentPre").append('<span id="deleteAtBeginParent"><span id="deleteAtBeginLogic"><span class="ct-green-color ct-css">void Sll::</span>'
				+ ' <span class="ct-green-color ct-css">deleteAtBegin()</span> {\n'
				+ '\t<span id="firstToTemp">node temp = first;</span>\n'
				+ '\t<span id="delBegIfCon">if (first == NULL) {</span>\n'
				+ '\t\t<span id="printfdelAtBeg1" style="display: inline-block">cout << "Single linked list is empty."\n'
				+ '\t\t\t" So deletion is not possible\\n";</span>\n\t} else {\n'
				+ '\t\t<span id="firstNextToFirst">first = first -> next;</span>\n'
				+ '\t\t<span id="printfdelAtBeg2" style="display: inline-block">cout << "The deleted element from SLL : "\n'
				+ '\t\t\t << temp -> data << "\\n";</span>\n'
				+ '\t\t<span id="freeNode" >delete temp;</span>\n\t}\n'
				+ '}</span></span>');
	}
...
function preDeleteEndMethod() {
	if (lang == 'c') {
		$("#parentPre").append('<span id="deleteAtEndParent"><span id="deleteAtEndLogic"><span class="ct-blue-color ct-css">node</span>'
				+ ' <span class="ct-green-color ct-css">deleteAtEnd(node first)</span> {\n'
		...
		$("#parentPre").append('<span id="deleteAtEndParent"><span id="deleteAtEndLogic"><span class="ct-green-color ct-css">void Sll::</span>'
...
function preDeletePositionMethod() {
	if (lang == 'c') {
		$("#parentPre").append('<span id="deleteAtPositionParent"><span id="deleteAtPositionLogic"><span class="ct-blue-color ct-css">node</span>'
				+ ' <span class="ct-green-color ct-css">deleteAtPosition(node first, int pos)</span> {\n'
		...
		$("#parentPre").append('<span id="deleteAtPositionParent"><span id="deleteAtPositionLogic"><span class="ct-green-color ct-css">void Sll::</span>'
				+ ' deleteAtPosition(<span class="ct-green-color ct-css">int</span> pos) {\n'
				+ '\t<span id="previousAndLastNode">node prevPos = first, lastNode = first;</span>\n'
				+ '\t<span id="iValInit">int i;</span>\n'
				+ '\t<span id="delPosIfCon">if (first == NULL) {</span>\n'
				+ '\t\t<span id="printfPos1" style="display: inline-block">cout << "Single Linked List is empty."\n'
				+ '\t\t" So deletion is not possible\\n";</span>\n\t} else {\n'
				+ '\t\t<span id="ifPosEqlToOne">if (pos == 1) {</span>\n'
				+ '\t\t\t<span id="fstnxtToFst">first = first -> next;</span>\n\t\t} else {\n'
				+ '\t\t\t<span id="forLoop">for (i = 1; i &lt; pos; i++) {</span>\n'
				+ '\t\t\t\t<span id="ifLastNodeEqToNull">if (lastNode == NULL) {</span>\n'
				+ '\t\t\t\t\t<span id="printfPos3" style="display: inline-block">cout << "No such position in SLL."\n'
				+ 'So deletion is not possible\\n";</span>\n'
				+ '\t\t\t\t}\n'
				+ '\t\t\t\t<span id="lastNodeIsPrevNode">prevPos = lastNode;</span>\n'
				+ '\t\t\t\t<span id="lastNextIsLast">lastNode = lastNode -> next;</span>\n\t\t\t}\n'
				+ '\t\t\t<span id="lastNullAndPosZero">if (lastNode == NULL || pos <= 0) {</span>\n'
				+ '\t\t\t\t<span id="printfPos4" style="display: inline-block"">cout << "No such position in SLL."\n'
				+ '\t So deletion is not possible\\n";</span>\n'
				+ '\t\t\t} else {\n'
				+ '\t\t\t\t<span id="lastNextIsPrevNext">prevPos -> next = lastNode -> next;</span>\n\t\t\t}\n\t\t}\n'
				+ '\t\t<span id="printfPos5" style="display: inline-block">cout << "The deleted element from SLL : "\n'
				+ '\t\t << lastNode -> data << "\\n";</span>\n'
				+ '\t\t<span id="freeLstNode" >delete lastNode;</span>\n\t}\n'
				+ '}</span></span>');
	}
	
}
function preCreateNode() {
	$("#createNodePre").append('<span id="nodeCreation"><span id="crteMtd"></span>{\n'
						+ '\tnode temp;\n'
						+ '\t<span id="createNodeSpan"></span>\n'
	...
	if (lang == 'c') {
		$('#createNodeSpan').html('temp = (<span class="ct-blue-color ct-css">node</span>)'
				+ '<span class="ct-green-color ct-css">malloc(sizeof(struct list))</span>;');
		$('#crteMtd').html('<span class="ct-blue-color ct-css">node</span>'
				+ ' createNode()');
	} else if (lang == 'cpp') {
		$('#createNodeSpan').html('temp = <span class="ct-brown-color ct-css">new</span>  list;')
		...
		switch (elementId) {
			...
			case "strcutSpan":
				...
				$('.introjs-helperLayer').one('transitionend', function() {
					var text = "This is the declaration of a new <span class='ct-code-b-yellow'>struct</span> type"
								+ " <span class='ct-code-b-yellow'> list</span>.<br><br>"
								+ "<ul><li><span class='ct-code-b-yellow'>data</span> field in node is used to hold"
								+ " <span class='ct-code-b-yellow'>data</span> inside linked list.</li>"
								+ "<li><span class='ct-code-b-yellow'>next</span> field in node is used to keep"
								+ " <span class='ct-code-b-yellow'>address of next node</span>.</li></ul>";
					typing('.introjs-tooltiptext', text, function() {
						$('.introjs-nextbutton').show();
					});
				});
			...
			case "typeDefDec":
				$('.introjs-helperLayer').one('transitionend', function() {
					...
					typing('.introjs-tooltiptext', text, function() {
						if (lang == 'c') {
							introNextStep("#nodeDec", 'hide');
						} else if (lang == 'cpp') {
							introNextStep("#sllClass", 'hide', "", "showClass");
						}
						$('.introjs-nextbutton').show();
					});
				});
			...
			case "sllClass" :
				$('.introjs-helperLayer').one('transitionend', function() {
					...
					switch(dynamicStep) {
						case "showClass":
							$('.introjs-tooltip').removeClass('hide');
							var text = "This is the declaring of a class <span class='ct-code-b-yellow'>Sll</span>.";
							typing('.introjs-tooltiptext', text, function() {
								introNextStep("#pubConstrt", 'hide');
								$('.introjs-nextbutton').show();
							});
						break;
						case "assgnFstNode" :
							...
							$('#arrowDiv').addClass('z-index1000000');
							transferEffect('#nodeDec', '#firstNode', function() {
								transferEffect('#assnNull', '#firstVal', function() {
									$('#arrowDiv').removeClass('z-index1000000');
									introNextStep("#buttonsDiv", '', 'bottom');
									setTimeout(function() {
										introjs.nextStep();
									}, 800);
								});
			...
			case "pubConstrt" :
				$('.introjs-helperLayer').one('transitionend', function() {
					$('.introjs-tooltip').removeClass('hide');
					var text = "This is the declaration of a <b class='ct-code-b-yellow'>class</b> constructor "
						+ " <b class='ct-code-b-yellow'>Sll</b> with the access specifier <b class='ct-code-b-yellow'>public</b>."
						typing('.introjs-tooltiptext', text, function() {
							introNextStep('#methodDec', 'hide');
							$('.introjs-nextbutton').show();
						});
				});	
			break;
			case "methodDec" :
				$('.introjs-helperLayer').one('transitionend', function() {
					...
					var text = "These are the declaration of a <b class='ct-code-b-yellow'>member functions</b> in a class"
								+ " <b class='ct-code-b-yellow'>Sll</b>."
						typing('.introjs-tooltiptext', text, function() {
							$('#whileCondParent').removeClass('hide').addClass('opacity00');
							introNextStep('#whileCondParent', 'hide', "", "decFirstInCpp" );
							$('.introjs-nextbutton').show();
						});
				});
			break;
			...
			case "buttonsDiv":
				...
				$("#lastNodeMemory, .temp-nodes, #parentPre").addClass("opacity00");
				
				$('.del-begin, .del-end, .del-position, .addnodes').removeClass("del-begin del-position del-end addnodes");
				$(".addnodes-clicked, .addnodes, .traverse-clicked, .insert-begin").removeClass('addnodes-clicked addnodes traverse-clicked insert-begin ');
				$('.insert-end, .searching, .counting, .insert-position').removeClass('insert-end searching counting insert-position');
				$("#line" + iVal + ", #line" + rVal + ", #lines22, #lines" + extraLine + '#line100').remove();
				if (lang == 'cpp') {
				...
				if (lang == 'c') {
					...
					if (introjs._currentStep == 9) {
						$('#structParent').empty().addClass('opacity00');
						clickMethods();
					}
				}
			...
			case "whileCondParent":
				...
				switch(dynamicStep) {
					case "decFirstInCpp":
						$('#ClassObject').html('<span id="objectOfClass">Sll s;</span>');
						$('#whileCondParent').removeClass('opacity00');
						customIntro('#objectOfClass', 'hide');
					break;
					case "inC":
			...
			case "objectOfClass" :
				$('.introjs-helperLayer').one('transitionend', function() {
					...
					var text = "Here, create an object <span class='ct-code-b-yellow'>s</span> for "
								+ "a class <span class='ct-code-b-yellow'>Sll</span>.";
					typing('.introjs-tooltiptext', text, function() {
						showButtons();
						introNextStep("#sllClass", 'hide', "", "assgnFstNode");
						$('.introjs-nextbutton').show();
					});
				});
			break;
			case "whilePrintStatmnt":
				...
				$('#lastNodeMemory').addClass('opacity00');
			break;
			case "whilePrintStatmnt1":
				$('#lastNodeMemory').addClass('opacity00');
					$('#line0, #lines22, #line' + iVal).remove();
				...
				$('.introjs-helperLayer').one('transitionend', function() {
					...
					switch(dynamicStep) {
						...
						case "addWhilePrinting":
							...
							if (lang == 'c') {
								outputTextAppend('#consoleEnter', text, '#whileScan' + scn, 'hide', '', '', true);
							} else if (lang == 'cpp') {
								outputTextAppend('#consoleEnter', text, '#whileScan' + scn, 'hide', '', '', true);
							}
							break;
						...
						case "addWhileTrue":
							...
							outputTextAppend('#consoleOutput', text, '#buttonsDiv', 'show', 'bottom', '', false);
							break;
						...
						case "traverseFalseWhile":
							...
							transferEffect("#nullPrint", "#nullSpan", function() {
								...
								$(".traverse-clicked").removeClass("traverse-clicked");
								introNextStep("#buttonsDiv", 'show', 'bottom');
								nextStepTiming();
							});
							break;
						...
						case "insertPosPrinting":
							...
							if (iVal == 0) {
								...
								outputTextAppend("#consoleOutput", text, idVal, 'hide', '', '', false);
							} else if (iVal > $('.nodes').length) {
								if (lang == 'c') {
									idVal = '#insertPosForIfReturn';
								}
								outputTextAppend("#consoleOutput", text, idVal, 'hide', '', '', false);
							} else {
								if (lang == 'c') {
									idVal = '#insertPosReturn';
								}
								outputTextAppend("#consoleOutput", text, idVal, 'hide', '', '', false);
							}
							break;
						...
						case "countStatment":
							...
							outputTextAppend("#consoleEnter", text, '#buttonsDiv', 'show', 'bottom', '', false);
							break;
						...
						case "printPosValue" :
							...
							outputTextAppend("#addElementOutputPrint", text, '#buttonsDiv', 'show', 'bottom', '', false);
						break;
			...
			case "trueCond":
				$("#whileLoop").remove();
				$('.introjs-helperLayer').one('transitionend', function() {
					introNextStep('#addNodeParent', 'show', 'bottom');
					if (lang == 'c') {
						...
						text = 'Here, we are calling <span class="ct-code-b-yellow">addNodes()</span> method and passing'
							+ ' <span class="ct-code-b-yellow">x</span> (i.e.,' + parseInt($("#whileVal").val()) + '</span>) as'
							+ ' arguments and the <span class="ct-code-b-yellow">return</span> value is stored in the'
							+ ' variable <span class="ct-code-b-yellow">first</span>.';
					}
					typing('.introjs-tooltiptext', text, function() {
						$('.introjs-nextbutton').show();
			...
			case "tempData":
				...
				case "returnFrst":
					$('.introjs-helperLayer').one('transitionend', function() {
						...
						if ($("#insertAtEndBtn").hasClass("insert-end")) {
							...
							iVal++;
							rVal++;
							introNextStep("#addMain", 'hide', "", 'inC');
							nextStepTiming();
						}
					});
					break;
				...
				case "arrowDiv":
					$('.introjs-helperLayer').one('transitionend', function() {
						...
						switch(dynamicStep) {
											...
											svgAnimatingLineRightToLeft("#arrowDiv", "#firstDiv", "#dataDiv" + iVal, "#svgId", "lines" + lineVal, 
												...
												if (lang == 'c') {
													...
													if ($("#insertAtEndBtn").hasClass("insert-end")) {
														...
														introNextStep("#whilePrintStatmnt1", 'hide', "", 'inC');
													}
												}
												setTimeout(function() {
													introjs.nextStep();
									...
									typing('.introjs-tooltiptext', text, function() {
										...
										fromEffect("#addWhileCond", "#whileCond", function() {
											$("#lastNodeMemoryVal").parent().effect("highlight", {color: 'blue'}, 500, function() {
												$("#lines22").fadeOut().remove();
												svgAnimatingLineTopToBottom("#arrowDiv", "#lastNodeMemory", "#dataDiv" + pos, "#svgId", "lines22"
														, "arrow", function() {
								...
								typing('.introjs-tooltiptext', text, function() {
									fromEffect("#lastNodeVal", "#lastNode1", function() {
										$("#lastNodeMemoryVal").parent().effect("highlight", {color: 'yellow'}, 500, function() {
											svgAnimatingLineTopToBottom("#arrowDiv", "#lastNodeMemory", "#dataDiv" + pos,
											...
											fadeInBounceEffectWithTimelineMax("#next" + rVal, "#tempNode" + pos, function() {
												rotationEffect("#traverseTempLine", $("#next" + (rVal)).text(), function() {
													...
													if ($('#tempNode' + pos).text() != "NULL") {
														svgAnimatingLineTopToBottom("#arrowDiv", "#tempNodeParent" + pos, "#nextDiv" + (rVal + 1),
																"#svgId", "lines52", "arrow");
													}
													rVal++;
							...
							case "secondStep":
								$("#lastNodeMemoryVal").parent().effect("highlight", {color: 'blue'}, 500, function() {
									svgAnimatingLineTopToBottom("#arrowDiv", "#lastNodeMemory", "#dataDiv" + (iVal - 1), "#svgId", "lines55",
											 "arrow", function() {
										$("#lines55").remove();
							...
							case "firstValStoredInLargest" :
								...
								if (lang == 'cpp' && $("#nodeAddress").length == 1) { 
									var x = '<div class="col-xs-1 col-xs-offset-1 padding0 opacity00 temp-nodes" id="tempNodeParent0'
			 							+ '"><div class="col-xs-12 box padding0"><span id="tempNode0'
										+ '" class="ct-brown-color ct-css opacity00 inline-style temp-node-val">1111</span></div> <div class='
										+ '"text-center col-xs-12 padding0 ct-green-color ct-css" id="tempName0">temp</div></div>';
												...
												rotationEffect("#curNodeNext", $("#tempNode0").text(), function() {
													fadeInFromEffectWithTimelineMax( '#tempNode0','#lastNodeMemoryVal', function() {
														if (parseInt($("#delVal").val()) != 1 && arrowFlag == true) {
															$("#lines" + prevPosLine).remove();
															svgAnimatingLineTopToBottom("#arrowDiv", "#lastNodeMemory", "#dataDiv" 
									                	...
									                	fadeInFromEffectWithTimelineMax( '#nextDiv'+(temp - 1),'#tempNode0', function() {
									                		...
									                		if ($('#tempNode0').text() != "NULL") {
									                			svgAnimatingLineTopToBottom("#arrowDiv", "#tempNodeParent0", "#dataDiv"
									                					+ (temp), "#svgId", "lines" + lastNodeLine, "arrow");
									                		}
				...
				case "callTraverseList":
					$('.introjs-helperLayer').one('transitionend', function() {
						introNextStep("#traverseParent", 'show', 'bottom');
						if (lang == 'c') {
							var text = "Here, we are calling <span class='ct-code-b-yellow'>traverseList()</span> function "
								+ "and passing first (i.e., <span class='ct-code-b-yellow'>" + $('#firstVal').text() + "</span>) as an argument.";	
						} else if (lang == 'cpp') {
							var text = "Here, we are calling <span class='ct-code-b-yellow'>traverseList()</span> function.";
						}
						typing('.introjs-tooltiptext', text, function() {
						...
						typing('.introjs-tooltiptext', text, function() {
							...
							transferEffect("#traverseTemp", "#tempNodeParent" + (pos), function() {
								transferEffect("#firstVal", "#tempNode" + (pos), function() {
									...
									if ($('#tempNode' + rVal).text() != "NULL") {
										svgAnimatingLineTopToBottom("#arrowDiv", "#tempNodeParent" + pos, "#nextDiv" + rVal,
												"#svgId", "lines52", "arrow");
									}
									introNextStep("#traverseWhileCond", 'show', 'bottom');
									$('.introjs-nextbutton').show();
								});
							});
						});
					...
					$('.introjs-helperLayer').one('transitionend', function() {
						...
						if (lang == 'c') {
							...
							text = 'Here, we are calling <span class="ct-code-b-yellow">insertAtBegin()</span> function and passing'
								...
								+ parseInt($("#whileVal").val()) + '</span>) as arguments and the' 
								+ ' <span class="ct-code-b-yellow">return</span> value is stored in the'
								+ ' variable <span class="ct-code-b-yellow">first</span>.';
						}
						typing('.introjs-tooltiptext', text, function() {
				...
				case "insertBeginTempDec":
					$('.introjs-helperLayer').one('transitionend', function() {
						...
						if (iVal > $('.nodes').length) {
							...
							if (lang == 'cpp') {
								$('#tempNodeParent' + (iVal - 1)).addClass("hide");
							}
				...
				case "insertPosCall":
					$('.introjs-helperLayer').one('transitionend', function() {
						introNextStep("#insertAtPositionParent", 'show', 'top');
						if (lang == 'c') {
							...
							var text = "Here, we are calling <span class='ct-code-b-yellow'>insertAtPosition()</span> function and passing"
								+ " <span class='ct-code-b-yellow'>pos,  x</span> (i.e., <span class='ct-code-b-yellow'>"
								+ parseInt($("#whileValPos").val()) + ", " + parseInt($("#whileVal").val()) 
								+ "</span>) as arguments and the <span class='ct-code-b-yellow'>return</span> value is stored in the"
								+ " variable <span class='ct-code-b-yellow'>first</span>.";
						}
						typing('.introjs-tooltiptext', text, function() {
					...
					$('.introjs-helperLayer').one('transitionend', function() {
						if (pos == 0) {
							$("#countMethod").effect("highlight", {color: 'yellow'}, 800, function() {
								introNextStep("#countParent", 'show', 'bottom');
								if (lang == 'c') {
									...
									var text = "Here, we are calling <span class='ct-code-b-yellow'>count()</span> function.";
								}
								typing('.introjs-tooltiptext', text, function() {
									$('.introjs-nextbutton').show();
								});
				...
				case "countParent":
					$('.introjs-helperLayer').one('transitionend', function() {
						var text = "This is the code to count the number of nodes in <b class='ct-code-b-yellow'>Single linked list</b>.";
						typing('.introjs-tooltiptext', text, function() {
							if ($(".temp-nodes").length > 0) {
							...
							transferEffect("#countTempDec", "#tempNodeParent0", function() {
								fadeInFromEffectWithTimelineMax("#firstVal", "#tempNode0", function() {
									if ($('#firstVal').text() != 'NULL') {
										$('#lines' + prevPosLine).remove()
										svgAnimatingLineTopToBottom("#arrowDiv", "#tempNodeParent0", "#nextDiv0", "#svgId", "lines" 
																						+ prevPosLine, "arrow");
										...
										$("#countSumDec").effect("highlight", {color : 'yellow'}, 800, function() {
											...
											typing('#appendText', text, function() {
												introNextStep("#countWhileCond", 'show', 'bottom');
												$('.introjs-nextbutton').show();
											});
										});
								});
				...
				case "deleteAtEndElement" :
					if (lang == 'c') {
						customIntro("#delIfCon");
					} else if (lang =='cpp') {
						customIntro("#assignFirstToLastNode", '', 'right');
					}
				break;
				...
				case "deleteAtPositionElement" :
					if (lang == 'c') {
						...
						iVal = 2;
						customIntro("#printfPos2", 'hide','', 'enterDeletePosition');
					}
				break;
				...
				case "callToPosDeleteFunction" :
					$('.introjs-helperLayer').one('transitionend', function() {
						...
						if (lang == 'c') {
							...
							var text = "Here, we are calling <span class='ct-code-b-yellow'>deleteAtPosition()</span> function and passing"
								+ " <span class='ct-code-b-yellow'>pos</span> (i.e., <span class='ct-code-b-yellow'>" 
								+ parseInt($("#delVal").val()) + " </span>) as arguments";
						}
						typing('.introjs-tooltiptext', text, function() {
							$('.introjs-nextbutton').show();
						});
					...
					$('.introjs-helperLayer').one('transitionend', function() {
						...
						typing('.introjs-tooltiptext', text, function() {
							if (lang == 'c') {
								...
								introNextStep('#delPosIfCon', 'show');
							}
							$('.introjs-nextbutton').show();
				...
				case "emptyMth":
					$('.introjs-helperLayer').one('transitionend', function() {
						$('.introjs-tooltip').removeClass('hide');
						var text = 'The <b class="ct-code-b-yellow">s.empty()</b> method will set'
							+ ' the <b class="ct-code-b-yellow">first</b> value to <b class="ct-code-b-yellow">NULL</b>.<br/><br/>'
							+ '<pre>void empty() {\n\tfirst = NULL;\n}</pre>';
						typing('.introjs-tooltiptext', text, function() {
							...
							$('.user-btn').click(function() {
								$('.user-btn').remove();
								$('#arrowDiv').addClass('z-index1000000');
								transferEffect('#emptyMth', '#firstVal', function() {
									$('#lines0').remove();
									$('#arrowDiv').removeClass('z-index1000000');
									$('#firstVal').text('NULL');
									introNextStep('#whilePrintStatmnt', 'hide', '', 'inC');
									$('.introjs-nextbutton').show();
								});
							});
						});
...
function addWhileEvent(id) {
	...
	$(id).on("keyup", function(e) {
		$('.error-text').remove();
		var con1 = (($(this).val().length > 0) && (!$(this).val().startsWith('-')));
		var con2 = ($(this).val().length >= 2 && ($(this).val().indexOf('-', $(this).val().indexOf('-') + 1) == -1));
		if (con1 || con2) {
			$('.introjs-nextbutton').show();
			...
			$('.introjs-tooltiptext').append('<div class="error-text ct-css">Please enter an integer value.</div>');
...
function clickMethods() {
	$("#whileCondParent, #parentPre").removeClass("hide");
	//$('#parentPre').removeClass('hide');
	...
	$("#countNodesBtn").click(function() {
		...
		$("#lastNodeName").text('lastNode');
		introNextStep("#parentPre", 'hide', 'bottom');
		pos = rVal = 0;
		introjs.nextStep();
	});
...
function methodSteps() {
	if ($("#addNodesBtn").hasClass("addnodes")) {
		...
		introNextStep('#whileCondParent', 'hide', '', 'inC');
...
function createNodeSpanAnimation() {
	...
	if (lang == 'c') {
		...
		var text = "<li><span class='ct-code-b-yellow'>new</span> operators creates <span class='ct-code-b-yellow'>dynamic memory</span>"
			+ " to the <span class='ct-code-b-yellow'>struct list</span> which contains <span class='ct-code-b-yellow'>two</span>"
			+ " fields <span class='ct-code-b-yellow'>data</span> and <span class='ct-code-b-yellow'>next</span>.</li>"
...
function tempNextAnimation() {
	...
	typing('.introjs-tooltiptext', text, function() {
		fromEffect("#countTempInc", "#countTempValue", function() {
			//$("#lines" + prevPosLine).remove();
			$("#tempNode0").parent().effect("highlight", {color: 'blue'}, 500, function() {
				svgAnimatingLineTopToBottom("#arrowDiv", "#tempNodeParent0", "#nextDiv" + (rVal - 1), "#svgId", "lines1" 
							+ prevPosLine, "arrow", function() {
					$('#lines1' + prevPosLine).remove();
					fadeInFromEffectWithTimelineMax("#next" + (rVal - 1), "#tempNode0", function() {
						$('#lines' + prevPosLine).remove(); 
						if ($('#nextDiv' + (rVal - 1)).text() != "NULL") {
							svgAnimatingLineTopToBottom("#arrowDiv", "#tempNodeParent0", "#nextDiv" + (rVal), "#svgId", "lines" 
									+ prevPosLine, "arrow");
						}
...
function lastNullAndPosToZeroAnimation() {
	...
	typing('.introjs-tooltiptext', text, function() {
		fromEffect("#lastNullAndPosZero", "#IfCurNextCon", function() {
			$("#curNodeNext").effect("highlight", {color: 'yellow'}, 500, function() {
				$("#tempNode0").parent().effect("highlight", {color: 'blue'}, 500, function() {
					rotationEffect("#curNodeNext", $("#tempNode0").text(), function() {
						...
						if (delAtEndCon) {
							...
							if (selector == "delBegIfCon") {
								if (lang == "c") {
									...
									introNextStep("#firstNextToFirst");//pop
								}
							} else if(selector == "delPosIfCon") {
								if (lang == 'c') {
				...
				rotationEffect("#curNodeNext", $("#firstVal").text(), function() {
					...
					fadeInFromEffectWithTimelineMax('#firstVal','#lastNodeMemoryVal', function() {
						if (lang == 'c') {
							...
							introNextStep("#delBegIfCon");
						}
						if ($('#firstVal').text() != "NULL") {
							$('#lines22').remove();
							svgAnimatingLineTopToBottom("#arrowDiv", "#lastNodeMemory", "#dataDiv0", "#svgId", "lines22", "arrow");
						}
						iVal = 2;
						$('.introjs-nextbutton').show();
					});
					...
					$('#firstVal').parent().effect( "highlight",{color: 'blue'}, 500, function() {
						rotationEffect("#curNodeNext", $("#firstVal").text(), function() {
							...
							if (lang == 'c') {
								...
								introNextStep("#delIfCon");
							}
							fromEffectWithTweenMax("#lastNodeMemoryVal", "#firstVal", $("#firstVal").text(), function() {
								if ($('#lastNodeMemoryVal').text() != "NULL") {
									svgAnimatingLineTopToBottom("#arrowDiv", "#lastNodeMemory", "#dataDiv" + rVal, "#svgId", "lines" + lastNodeLine, 
											"arrow", function() {
										$('.introjs-nextbutton').show();
									});
								} else {
...
function checkIfLastNodeIsNull() {
	fromEffect("#checkLastNodeNull", "#IfCurNextCon", function() {
		$("#lastNodeMemoryVal").parent().effect("highlight", {color: 'blue'}, 500, function() {
			svgAnimatingLineTopToBottom("#arrowDiv", "#lastNodeMemory", "#dataDiv" + rVal, "#svgId", "lines45", 
					"arrow", function() {
				$("#lines45").remove();
				$("#nextDiv" + rVal).effect("highlight", {color: 'blue'}, 500, function() {
					rotationEffect("#curNodeNext", $("#nextDiv" + rVal).text(), function() {
...
function WhileLastNodeNotEqualToNull() {
	fromEffect("#checkLastNodeNotEqlToNull", "#IfCurNextCon", function() {
		$("#curNodeNext").effect("highlight", {color: 'yellow'}, 500, function() {
			$("#lastNodeMemoryVal").parent().effect("highlight", {color: 'blue'}, 500, function() {
				svgAnimatingLineTopToBottom("#arrowDiv", "#lastNodeMemory", "#dataDiv" + pos, "#svgId", "lines" + lineCount, 
		             "arrow", function() {
		 			$("#lines" + lineCount).remove();
...
function lastNextEqlLastNode() {
	fromEffect("#lastNextEqlLast", "#IfCurNextCon", function() {
		$("#curNodeNext").effect("highlight", {color: 'yellow'}, 500, function() {
			$("#lastNodeMemoryVal").parent().effect("highlight", {color: 'blue'}, 500, function() {
				$("#lines" + extraLine).remove();
				svgAnimatingLineTopToBottom("#arrowDiv", "#lastNodeMemory", "#dataDiv" + pos, "#svgId", "lines" + extraLine, "arrow", function() {
					$("#lines" + lastNodeLine).remove();
					$("#nextDiv" + pos).effect("highlight", {color: 'blue'}, 500, function() {
						rotationEffect("#curNodeNext", $("#nextDiv" + pos).text(), function() {
              				fadeInFromEffectWithTimelineMax('#nextDiv' + pos, '#lastNodeMemoryVal', function() {
                				$("#lines" + extraLine).fadeOut().remove();
                				pos++;
                				svgAnimatingLineTopToBottom("#arrowDiv", "#lastNodeMemory", "#dataDiv" + pos, "#svgId", "lines" + lastNodeLine,
					            	"arrow", function() {
                					introNextStep("#checkLastNodeNotEqlToNull", 'hide');
									$('.introjs-nextbutton').show();
                 				});
...
function prevsAndLastNode() {
	if (lang == 'cpp' && $("#nodeAddress").length == 1) { 
		var x = '<div class="col-xs-1 col-xs-offset-1 padding0 opacity00 temp-nodes" id="tempNodeParent0'
				+ '"><div class="col-xs-12 box padding0"><span id="tempNode0'
			+ '" class="ct-brown-color ct-css opacity00 inline-style temp-node-val"></span></div> <div class='
			+ '"text-center col-xs-12 padding0 ct-green-color ct-css" id="tempName0">temp</div></div>';
		$("#nodeAddress").append(x);
	}
			...
			$("#firstDiv").effect("highlight", {color: 'blue'}, 500, function() {
				fadeInFromEffectWithTimelineMax('#firstVal','#lastNodeMemoryVal', function() {
					...
					fadeInFromEffectWithTimelineMax('#firstVal','#tempNode0', function() {
						iVal = 2;
						if ($('#firstVal').text() != "NULL") {
							svgAnimatingLineTopToBottom("#arrowDiv", "#lastNodeMemory", "#dataDiv" + rVal, "#svgId", "lines" + prevPosLine, 
									"arrow", function() {
		...
		transferEffect("#tempDec", "#tempNodeParent" + rVal, function() {
			transferEffect("#lastNodeDec", "#lastNodeMemory", function() {
				fadeInFromEffectWithTimelineMax("#firstVal", "#lastNodeMemoryVal", function() {
					if ($('.nodes').length > 0) {
						$('#lines22').remove();
						svgAnimatingLineTopToBottom("#arrowDiv", "#lastNodeMemory", "#dataDiv0", "#svgId", "lines22", "arrow", function() {
							$("#arrowDiv").removeClass("zindex");
