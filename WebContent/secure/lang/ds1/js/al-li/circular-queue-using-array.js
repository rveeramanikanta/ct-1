...
CircularQueueArray.prototype.enqueue = function(elemToPush) {
	...
	this.cmd("Step");
	this.cmd("Step");
	this.cmd("SetNextIntroStep", "#enqueuMethod", '', 'right', '');
	this.cmd("RunNextIntroStep");
	this.cmd("Step");
	this.cmd("Step");
...
CircularQueueArray.prototype.dequeue = function(ignored) {
	...
	$('#queueMain').removeClass('hide');
	$("#mainCallMethod *").removeAttr("id");
	$('#mainCallMethod').append('<span id="lastCall">dequeue();</span>\n');
	this.cmd("SetNextIntroStep", "#lastCall", '', '', 'hide');
	this.cmd("RunNextIntroStep");
	this.cmd("Step");
	this.cmd("Step");
	this.cmd("SetNextIntroStep", "#dequeuMethod", '', 'right', '');
	this.cmd("RunNextIntroStep");
	this.cmd("Step");
	this.cmd("Step");
	...
	if (this.front != -1) {
		...
		this.cmd("Step");
		this.cmd("Step");
		this.cmd("SetNextIntroStep", "#animationDiv", "", "", "hide");
		this.cmd("RunNextIntroStep");
		this.cmd("Step");
		this.cmd("Step");
		...
		this.cmd("Step");
		this.cmd("Step");
		this.cmd("SetNextIntroStep", "#dequeDiv", "", "right");
		this.cmd("RunNextIntroStep");
		this.cmd("Step");
		this.cmd("Step");
...
CircularQueueArray.prototype.displayAll = function() {
	...
	$('#queueMain').removeClass('hide');
	$("#mainCallMethod *").removeAttr("id");
	$('#mainCallMethod').append('<span id="lastCall">display();</span>\n');
	this.cmd("SetNextIntroStep", "#lastCall", '', '', 'hide');
	this.cmd("RunNextIntroStep");
	this.cmd("Step");
	this.cmd("Step");
	this.cmd("SetNextIntroStep", "#displayMethod", '', 'right', '');
	this.cmd("RunNextIntroStep");
	this.cmd("Step");
	this.cmd("Step");
	...
	if (this.front != -1 && this.rear != -1) {
		...
		this.cmd("Step");
		this.cmd("Step");
		this.cmd("SetNextIntroStep", "#displayDiv", "", "right");
		this.cmd("RunNextIntroStep");
		this.cmd("Step");
		this.cmd("Step");
