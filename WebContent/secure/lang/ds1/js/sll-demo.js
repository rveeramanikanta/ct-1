...
function addMainMethod() {
	$("#mainFunctions").append('<span id="addMain"><span id="whilePrintStatmnt">printf("Enter elements up to -1 : ");</span>\n'
							...
							+ '\t<span id="trueCond">first = <span class="ct-purple-color ct-css">addNodes(first, x);</span></span>\n'
							+ '\tscanf("%d", &x);\n}</span>');
}
...
function displayMainMethod() {
	$("#mainFunctions").append('<span id="displayMain">if (<span id="displayIfMain">first == NULL</span>) {\n'
							...
							+ '\t<span id="callTraverseList"><span class="ct-purple-color ct-css">traverseList(first);</span></span>\n}</span>');
}
...
function preInsertBeginMainMethod() {
	$("#mainFunctions").append('<span id="insertAtBeginMain"><span id="insertAtBeginPrint">printf("Enter any number : ");</span>\n'
							...
							+ '<span id="insertAtBeginFunction">first = <span class="ct-purple-color ct-css">insertAtBegin(first, x);</span></span></span>');
}
...
function preInsertEndMainMethod() {
	$("#mainFunctions").append('<span id="insertAtEndMain"><span id="insertAtEndPrintf">printf("Enter any number : ");</span>\n'
							...
							+ '<span id="insertAtEndCall">first = <span class="ct-purple-color ct-css">insertAtEnd(first, x);</span></span></span>');
}
...
function preInsertPositionMainMethod() {
	$("#mainFunctions").append('<span id="insertAtPositionMain"><span id="insertPositionPosPrintf">printf("Enter a position : ");</span>\n'
							...
							+ '<span id="insertPosCall">first = <span class="ct-purple-color ct-css">insertAtPosition(first, pos, x);</span></span></span>');
}
...
function preCountMainMethod() {
	$("#mainFunctions").append('<span id="countMain" style="display: inline-block">printf("The number of nodes in a SLL are : \n\t\t\t\t%d\\n",'
							+ ' <span id="countMethod" class="ct-purple-color ct-css">count(first)</span>);</span>');
}
...
function preSearchMainMethod() {
	$("#mainFunctions").append('<span id="searchElement"><span id="initVar">int x, pos;</span>\n'
							...
							+ '<span id="calSrhMethod">pos = <span id="callSearchMethod" class="ct-purple-color ct-css">searchPosOfEle(first, x);</span></span>\n'
...
function preDeleteBeginMainMethod() {
	$("#mainFunctions").append('<span id="deleteAtBeginElement"><span id="delBegIfCon">if (first == NULL) {</span>\n'
							...
							+ '\t<span id="callDelAtBeginMethod">first = <span class="ct-purple-color ct-css">deleteAtBegin(first);</span></span>\n}</span>');	
}
...
function preDeleteEndMainMethod() {
	$("#mainFunctions").append('<span id="deleteAtEndElement"><span id="delIfCon">if (first == NULL) {</span>\n'
							...
							+ '\t" So deletion is not possible\\n");</span>\n} else {\n'
							+ '\t<span id="callDelAtEndMethod">first = <span class="ct-purple-color ct-css">deleteAtEnd(first);</span></span>\n}</span>');
}
...
function preDeletePositionMainMethod() {
	$("#mainFunctions").append('<span id="deleteAtPositionElement"><span id="delPosIfCon">if (first == NULL) {</span>\n'
							...
							+ '\t<span id="callToPosDeleteFunction">first = <span class="ct-purple-color ct-css">deleteAtPosition(first, pos);</span></span>\n}</span>');	
}

function preAddNodeMethod() {
	$("#parentPre").append('<span id="addNodeParent"><span id="addNodeMethod" class="hide"><span class="ct-blue-color ct-css">node</span>'
						+ ' <span class="ct-green-color ct-css">addNodes(node first, int x)</span> {</span>'
						+ '<span id="insertAtEndMethod" class="hide"><span class="ct-blue-color ct-css">node</span>'
						+ ' <span class="ct-green-color ct-css">insertAtEnd(node first, int x)</span> {</span>\n'
						+ '\tnode <span id="tempDec">temp</span>, <span id="lastNodeDec">lastNode = first;</span>\n'
						+ '\t<span id="createCall">temp = <span class="ct-purple-color ct-css">createNode();</span></span>\n'
...
function preInsertBeginMethod() {
	$("#parentPre").append('<span id="insertAtBeginParent"><span class="ct-blue-color ct-css">node</span>'
						...
						+ '\t<span id="createCallBegin">temp = <span class="ct-purple-color ct-css">createNode();</span></span>\n'
...
function preInsertPositionMethod() {
	$("#parentPre").append('<span id="insertAtPositionParent"><span class="ct-blue-color ct-css">node</span>'
						...
						+ '\t<span id="insertPosCreateCall">temp = <span class="ct-purple-color ct-css">createNode();</span></span>\n'
...
function preCountMethod() {
	$("#parentPre").append('<span id="countParent">int <span class="ct-green-color ct-css">count(node first)</span> {\n'
...
function preSearchMethod() {
	$("#parentPre").append('<span id="searchParent"><span id="searchLogic">int'
...
function preDeleteBeginMethod() {
	$("#parentPre").append('<span id="deleteAtBeginParent"><span id="deleteAtBeginLogic"><span class="ct-blue-color ct-css">node</span>'
						...
						+ '\t\t"%d\\n", temp -> data);</span>\n'
						+ '\t<span id="freeNode" class="ct-purple-color ct-css">free(temp);</span>\n'
...
function preDeleteEndMethod() {
	$("#parentPre").append('<span id="deleteAtEndParent"><span id="deleteAtEndLogic"><span class="ct-blue-color ct-css">node</span>'
						...
						+ '\t\t\t"%d\\n", lastNode -> data);</span>\n'
						+ '\t<span id="freeLastNode" class="ct-purple-color ct-css">free(lastNode);</span>\n'
...
function preDeletePositionMethod() {
	$("#parentPre").append('<span id="deleteAtPositionParent"><span id="deleteAtPositionLogic"><span class="ct-blue-color ct-css">node</span>'
						...
						+ '\t" %d\\n", lastNode -> data);</span>\n'
						+ '\t<span id="freeLstNode" class="ct-purple-color ct-css">free(lastNode);</span>\n'
						+ '\t<span id="retnFst2">return first;</span>\n}</span></span>');
}
function preCreateNode() {
	$("#createNodePre").append('<span id="nodeCreation"><span class="ct-blue-color ct-css">node</span>'
						+ ' <span class="ct-green-color ct-css">createNode()</span> {\n'
						+ '\tnode temp;\n'
						+ '\t<span id="createNodeSpan">temp = (<span class="ct-blue-color ct-css">node</span>)'
						+ '<span class="ct-green-color ct-css">malloc(sizeof(struct listNode))</span>;</span>\n'
...
function createNodeSpanAnimation() {
	...
	var text = "<li><span class='ct-code-b-yellow'>malloc()</span> creates a <span class='ct-code-b-yellow'>dynamic memory</span>"
				+ " to the <span class='ct-code-b-yellow'>struct listNode</span> which contains <span class='ct-code-b-yellow'>two</span>"
