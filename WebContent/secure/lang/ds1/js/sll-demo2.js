...
function preAddNodeMethod() {
	$("#parentPre").append('<span id="addNodeParent"><span id="addNodeMethod" class="hide">'
						+ '<span class="ct-blue-color ct-css">node</span> addNodes(node first, int x) {</span>'
						+ '<span id="insertAtEndMethod" class="hide"><span class="ct-blue-color ct-css">node</span>'
						+ ' insertAtEnd(node first, int x) {</span>\n'
...
function preInsertBeginMethod() {
	$("#parentPre").append('<span id="insertAtBeginParent"><span class="ct-blue-color ct-css">node</span> insertAtBegin(node first, int x) {\n'
...
function preDeletePositionMethod() {
	$("#parentPre").append('<span id="deleteAtPositionParent"><span id="deleteAtPositionLogic"><span class="ct-blue-color ct-css">node</span>'
						+ ' deleteAtPosition(node first, int pos) {\n'
...
function preCreateNode() {
	$("#createNodePre").append('<span id="nodeCreation"><span class="ct-blue-color ct-css">node</span> createNode() {\n'
							+ '\tnode temp;\n'
