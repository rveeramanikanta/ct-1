...
<div>
	<h2 class="text-center">
		<span class="label label-default ct-demo-heading" id="heading">Circular queue using array</span>
	</h2>
</div>
...
<span id="queueMax">int item[MAX];</span></div>
			...
			<div id ="totalTable" class="text-center table-padding">
				<div class="col-xs-12">
					<table id ="animationTable" class="opacity00 table-css" align="center">
						...
						<tr id="arrayValues">
							<%for( int i = 0; i < 10; i++) {%>
								<td class ="table-border opacity00" id="box<%=i%>"><span class = "padding6"></span></td>
							<%} %>
						</tr>
						<tr id="lowerArrow">
							<%for( int i = 0; i < 10; i++) {%>
					...
					switch(animateStep) {
						case "enqueueMethod":
							...
							$("#methodCode").append('<div id="enqueueMethod">'
								...
								+ '<span id = "ifCondition2">&emsp;&emsp;<span class="ifClass" id = "line7">if (<span id = "flipRear3">' 
										+ 'rear</span> == <span id = "totalMax"><span id = "flipMax">MAX</span> - 1</span>) {</span></br>'
								+ '&emsp;&emsp;&emsp;<span class="ifClass" id = "line8">rear = -1;</span></br>'
								+ '&emsp;&emsp;<span id = "line9"><span class="ifClass">}</span> <span class="elseIfClass">else if (<span id = "flipFront4">front</span> == -1) {</span></span></br>' 
								+ '&emsp;&emsp;&emsp;<span class ="elseIfClass" id = "line10">front = 0;</span></br>'
								+ '&emsp;&emsp;<span class="elseIfClass">}</span></br>'
						...
						case "dequeueMethod":
							...
							$("#methodCode").append('<div id="dequeueMethod">'
								...
								+ '<span id= "ifElseCondition">&emsp;&emsp;<span class="ifClass" id = "line6">if (' 
										+ '<span id ="flipFrontSpan">front</span> == ' 
										+ '<span id ="flipRearSpan">rear</span>) {</span></br>'
								+ '&emsp;&emsp;&emsp;<span class="ifClass" id = "line7">front = rear = -1;</span></br>'
								+ '&emsp;&emsp;<span id = "line8"><span class="ifClass">}</span> <span class="elseIfClass">else if (<span id="frontFlip" class="display-inline-css">front</span> == <span class="display-inline-css" id="maxFlip">MAX</span>-1) {</span></span></br>'
								+ '&emsp;&emsp;&emsp;<span class="elseIfClass" id = "line9">front = 0;</span></br>'
								+ '&emsp;&emsp;<span id = "line10"><span class="elseIfClass">}</span> <span class="elseClass">else {</span></span></br>'
								+ '&emsp;&emsp;&emsp;<span class="elseClass" id = "line11">front = front + 1;</span></br>'
						...
						case "enqueueAnimation":
							...
							$("#entreValue").effect("highlight", {"color" : "yellow", "z-index" : "9999999"}, function() {
								...
								TweenMax.to("#xValue", 1, {"top":0, "left": 0, onComplete:function() {
									$("#methodCode").addClass("z-index-css");
									var text = '<ul><li><span id="conditionText"></span><span class="yellow-color" id="checkIf1"></span>' 
											+ '</li><li class="opacity00"><span id="flipSpan"></span></li><li class="opacity00">' 
											+ '<span id="checkIfText"></span></li></ul>';
									typing(".introjs-tooltiptext", text, function() {
										...
										typing("#conditionText", "The condition is, ", function() {
											TweenMax.to("#checkIf1", 1, {"top" : "0", "left" : "0", onComplete:function() {
												...
												fromEffect("#flipSpan", "#checkIf1", function() {
													flipEffect("#flipSpan #flipRear1", rear, function() {
														flipEffect("#flipSpan #max", "10", function() {
															flipEffect("#flipSpan #totalMax", "9", function() {
																flipEffect("#flipSpan #flipFront1", front, function() {
																	flipEffect("#flipSpan #flipRear2", rear, function() {
																		flipEffect("#flipSpan #totalRear", (rear + 1), function() {
																			flipEffect("#flipSpan #flipFront2", front, function() {
					...
					flipEffect("#checkIf1 #flipRear3", rear, function() {
						flipEffect("#checkIf1 #flipMax", "10", function() {
							flipEffect("#checkIf1 #totalMax", "9", function() {
								if (rear == 9) {
									$(".introjs-tooltiptext .elseIfClass").addClass("white-color");
		...
		typing("#conditionText", "The condition is, ", function() {
			TweenMax.to("#checkCond", 1, {top : 0, left : 0, onComplete: function() {
				...
				fromEffect("#flipSpan", "#checkCond", function() {
					flipEffect("#flipSpan #flipFrontVar", front, function() {
						$(".introjs-tooltiptext ul li:last").removeClass("opacity00");
						if (front == -1) {
							var text1 = "Condition evaluates to <span class='yellow-color'>true</span>.";
...
function elseOfDequeue() {
	$(".nextButton").remove();
	var text = "<span class='yellow-color' id='checkCond'>";
	typing(".introjs-tooltiptext", text, function() {
...
function elseIfElseOfDequeue() {
	...
	typing (".introjs-tooltiptext", text, function() {
		...
		TweenMax.to("#if", 1, {top : 0, left : 0, onComplete:function() {
			$("#if #line6").effect("highlight", {"color" : "yellow"}, function() {
				flipEffect("#if #flipFrontSpan", front , function() {
					flipEffect("#if #flipRearSpan", rear , function() {
						if (front == rear) {
							$(".introjs-tooltiptext .elseIfClass, .introjs-tooltiptext .elseClass").addClass("white-color");
							$("#if #line7").effect("highlight", {"color" : "yellow"}, function() {
							...
							$("#if #line8").effect("highlight", {"color" : "yellow"}, function() {
								flipEffect("#if #frontflip", front , function() {
									flipEffect("#if #maxFlip", 9 , function() {
										$(".introjs-tooltiptext .ifClass, .introjs-tooltiptext .elseClass").addClass("white-color");
										$("#if #line9").effect("highlight", {"color" : "yellow"}, function() {
											front = 0;
										});
									});
								});
							...
							$("#if #line8").effect("highlight", {"color" : "yellow"}, function() {
								flipEffect("#if #frontFlip", front , function() {
									flipEffect("#if #maxFlip", 9 , function() {
										$(".introjs-tooltiptext .elseIfClass, .introjs-tooltiptext .ifClass").addClass("white-color");
										$("#if #line10").effect("highlight", {"color" : "yellow"}, function() {
											$("#if #line11").effect("highlight", {"color" : "yellow"}, function() {
