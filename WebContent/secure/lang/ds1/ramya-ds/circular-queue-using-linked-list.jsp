...
<div>
	<h2 class="text-center">
		<span class="label label-default ct-demo-heading" id="heading">Circular queue using linked list</span>
	</h2>
</div>
<div class="col-xs-12">
	<div class="col-xs-4">
	...
	<div class="col-xs-8">
		...
		<div class="col-xs-12 margin-top20">
			<div class="col-xs-12 border margin-top20 animation-div opacity00" id="animationDiv">
				<div class="col-xs-offset-3 col-xs-3 margin-top20 x-div visibility-hidden" id="xDiv" align ="center" style ="margin-top:41px;">
					<span id = "x" class="">x =&emsp;</span>
					<span class="variable-border" id ="xValueBorder">
					<span class="x-value" id="xValue"></span></span>
				</div>
				<div class="col-xs-4 margin-top20 t-div opacity00" id="tDiv" align ="left" style="display: inline-flex; position: relative; height: 100px;">
					<div id = "t" class="margin-top20">t&emsp;</div>
					<div><i class="fa fa-arrow-right margin-top20" aria-hidden="true"></i>&emsp;</div>
					<div class="col-xs-12" id="dynamicnodesDiv" style="position:relative;"></div>
				</div>
				<div class="col-xs-12" id="frontDiv"></div>
				<div class="col-xs-12" id="nodesDiv">
					<div id="nodeInnerDiv"></div>
				</div>
				<div class="col-xs-12" id="rearDiv"></div>
			</div>
		</div>
	</div>
</div>
					...
					switch(animateStep) {
						case "enqueueMethod":
							...
							$("#methodCode").append('<div id="enqueueMethod">'
								...
								+ '&emsp;&emsp;<span class="ifClass">}</span> <span class="elseClass"><span id="line10">else</span> {</span></br>'
								+ '&emsp;&emsp;&emsp;&emsp;<span class="elseClass" id="line11">rear->next = t;</span></br>'
								+ '&emsp;&emsp;<span class="elseClass">}</span></span></br>'
								+ '&emsp;&emsp;<span class="elseClass" id="line12">rear = t;</span></br>'
								+ '&emsp;&emsp;<span class="elseClass" id="line13">rear->next = front;</span></br>'
								+ '<span>}</span></div>');
							intro.refresh();
						...
						case "dequeueMethod":
							...
							$("#methodCode").append('<div id="dequeueMethod">'
									...
									+ '<span id="ifElseCondition">&emsp;&emsp;&emsp;<span class="ifClass" id="line6">if (<span id="flipFront">' 
											+ 'front</span> == <span id="flipRear">rear</span>) {</span></br>'
									+ '&emsp;&emsp;&emsp;&emsp;<span class="ifClass" id="line7">front = rear = NULL;</span></br>'
									+ '&emsp;&emsp;&emsp;<span id="line8"><span class="ifClass">}</span> <span class="elseClass">else {</span></span></br>'
									+ '&emsp;&emsp;&emsp;&emsp;<span class = "elseClass" id="line9">front = front->next;</span></br>'
									+ '&emsp;&emsp;&emsp;&emsp;<span class="elseClass" id="line10">rear->next = front;</span></br>'
									+ '&emsp;&emsp;&emsp;<span class="elseClass">}</span></span></br>'
...
function dequeueIfCondition() {
	$(".nextButton").remove();
	$("#stmts").addClass("display-inline-css");
	$("#ifElseCondition").effect("highlight", {"color" : "yellow"}, function() {
