...
<title>double circular linked list</title>
<style type="text/css">
...
$(document).ready(function() {
						...
						switch(animateStep) {
							case "createMethod" :
								...
								$("#methodId").append('<div class="opacity00" id="createMethodId"><pre>node create(node first) {<br/>'
										...
										+ '<div id="whileLoop" style="display: inline-block;">' 
											+ '&emsp;&emsp;<span class="whileClass" id= "line5">while(<span id= "flipX" style="display: inline-block;">x</span> != -1) {</span><br/>'
							...
							case "insertAtBeginMethod" :
								...
								$("#methodId").append('<div class="opacity00" id="insertAtBeginMethodId"><pre>node inbegin(node first) {<br/>'
										...
										+ '<span id="ifCondition">&emsp;<span class="ifClass" id= "line8">if(' 
												+ '<span class ="display-inline-css" id="flipFirst1">first</span> == NULL) {</span><br/>'
							...
							case "insertAtEndMethod":
								...
								$("#methodId").append('<div class="opacity00" id="insertAtEndMethodId"><pre>node insertAtEnd(node first) {<br/>'
										...
										+ '&emsp;&emsp;<span id= "line6">while(q->next != first) {</span><br/>'
										+ '&emsp;&emsp;&emsp;<span id= "line7">q = q->next;</span><br/>'
										+ '&emsp;&emsp;<span id= "line8">}</span><br/>'
										...
										+ '&emsp;&emsp;<span id= "line15">temp->next = first;</span><br/>'
										+ '&emsp;&emsp;<span id= "line16">first->prev = temp;</span><br/>'
										+ '&emsp;&emsp;<span id= "line17">temp->prev = q;</span><br/>'
										+ '&emsp;<span id= "line18">}</span><br/>'
										+ '&emsp;<span id= "line19">return first;</span><br/>'
							...
							case "deleteAtEndMethod":
								...
								$("#methodId").append('<div class="opacity00" id="deleteAtEndMethodId"><pre>node deleteAtEnd(node first) {<br/>' 
										...
										+ '&emsp;&emsp;<span id="line9">temp = q->prev;</span><br/>' 
					...
					$(".introjs-helperLayer").one('transitionend', function() {
						...
						switch(animateStep) {
							case "createAnimation":
								...
								typing(".introjs-tooltiptext", text, function() {
									fromEffect("#createWhileLoop", ".whileClass", function() {
										$("#createWhileLoop span").effect("highlight",{color: 'yellow'}, 1000, function() {
											flipEffect("#createWhileLoop > #flipX", $("#xBox").text() , function() {
												if ($("#xBox").text() != -1) {
													$("#createWhileLoop").effect("highlight",{color: 'yellow'}, 1000, function() {
														$("#node" + count).removeClass("opacity00");
														TweenMax.from($("#node" + count), 1, {top: -100, onComplete:function() {
															$("#prevAddress" + count).effect("highlight",{color: 'yellow'}, 1000, function() {
							...
							case "createLine20Animation":
								$("#nextAddress" + (count - 1)).effect("highlight", {"color" : "yellow"}, function() {
									fromEffectWithOnlyText("#prev0", "#prevAddress" + (count - 1), function() {
										var text = "345";
										typing(".introjs-tooltiptext", text, function() {
											$(".introjs-nextbutton").show();
										});
																			...
																			typing("#xValueText", text1, function() {
																					...
																					TweenMax.to("#next" + (count - 1),1,{top:0,left:0, onComplete:function() {
																						...
																						rightToLeftArrow("#animationDiv", "#nextDiv" + (count-1), "#prevDiv" + count, "#svgId", "rightLines" + arrowCount, "arrow", function() {
																							...
																							$("#prevAddress0").effect("highlight", {"color" : "yellow"}, function() {
																								//bring stmt
																								fromEffectWithOnlyText("#next" + count, "#prevAddress0", function() {
	...
	function createstoringCircularAddress() {
		$(".nextButton").remove();
		$("#line21").effect("highlight", {"color" : "yellow"}, function() {
			fromEffectWithOnlyText("#next0", "#prevAddress" + (count - 1), function() {
				$("#line22").effect("highlight", {"color" : "yellow"}, function() {
					$(".introjs-nextbutton").show();
				});
			});
			...
			/* $("#line7").effect("highlight",{color: 'yellow'}, 1500, function() {
				...
				TweenMax.to("#createWhileLoopContent1",1,{top:0,left:0, onComplete:function() { */
					//typing("#textSpan1", "<br>This statement will keep NULL in prev of the temp.", function() {
						...
						$(".createWhileLoop").effect("highlight",{color: 'yellow'}, 1500, function() {
							$("#prev" + count).text("NULL").removeClass("visibility-hidden");
							$("#createWhileLoop #line8").effect("highlight",{color: 'yellow'}, 1500, function() {
								var l1= $("#line8").offset();
								...
								TweenMax.to("#createWhileLoopContent1",1,{top:0,left:0, onComplete:function() {
									...
									flipEffect("#createWhileLoopContent1 > #flipX1", $("#xBox").text() , function() {
										//typing("#textSpan1", "<br>This statement will insert given value " + $("#inputIdField").val() + " in info of the temp.", function() {
											...
											TweenMax.to("#info" + count,1,{top:0,left:0, onComplete:function() {
												$("#info" + count).removeClass("z-index-transfer yellow-color"); */
												$("#createWhileLoop #line9").effect("highlight",{color: 'yellow'}, 1500, function() {
													/* var l1= $("#line9").offset();
	...
	function insertBeginFirstStep() {
		$(".nextButton").remove();
		//var text = "<span class='yellow-color' id='xValue1'></span></br><span id='xText1'></span>";
	...
	function insertPositionFirstStep() {
		$(".nextButton").remove();
		$("#line10").effect( "highlight",{color: 'yellow'}, 1000, function() {
			if (position == 1) {
				$("#line11").effect("highlight", {color: 'yellow'}, 1000, function() {
					insertAtBeginMethodDynamicSteps();
				});
					...
					$("#line13").effect( "highlight",{color: 'yellow'}, 1000, function() {
						...
						TweenMax.to("#pValue", 1,{top : 0,left : 0, onComplete : function() {
							...
							$(".introjs-tooltipbuttons").append("<a class='introjs-button nextButton' " 
									+ "onclick = 'insertPositionSecondStep()'>Next &#8594;</a>");
						}});
					});
				});
			}
			...
			if (position == 1) {
				...
				$("#line12").effect("highlight", {"color" : "yellow"}, 1000, function() {
					$("#line13").effect("highlight", {"color" : "yellow"}, 1000, function() {
						...
						$("pVlaue").addClass("z-index-transfer yellow-color");
						TweenMax.to("#pValue", 1, {top : 0, left : 0, onComplete : function() {
							$("pValue").addClass("z-index-transfer yellow-color");
							$(".introjs-tooltipbuttons").append("<a class = 'introjs-button nextButton' " 
									+ "onclick = 'insertPositionSecondStep()'>Next &#8594;</a>");
		...
		$("#line14").effect( "highlight",{color: 'yellow'}, 2000 ,function() {
			...
			TweenMax.from($("#node" + count), 1, {top: -100, onComplete:function() {
				...
				TweenMax.to("#tempDiv",1,{top:0,left:0, onComplete:function() {
					$("#tempDiv").removeClass("z-index-transfer yellow-color");
					changeIds();
					$("#line15").effect( "highlight",{color: 'yellow'}, 1000 ,function() {
						$('.introjs-nextbutton').show();
					});
				}});
			}});
	...
	function insertPositionRemainingFirstStep() {
		$(".nextButton").remove();
		$("#line19").effect("highlight",{color: 'yellow'}, 1000, function() {
	...
	function insertPositionRemainingSecondStep() {
		$(".nextButton").remove();
		$("#line20").effect("highlight",{color: 'yellow'}, 1000, function() {
			var l1 = $("#tempDiv").offset();
	...
	function insertPositionRemainingThirdStep() {
		$(".nextButton").remove();
		$("#line21").effect("highlight",{color: 'yellow'}, 1000, function() {
			var l1 = $("#tempDiv").offset();
	...
	function insertPositionRemainingThirdStep() {
		$(".nextButton").remove();
		$("#line22").effect("highlight",{color: 'yellow'}, 1000, function() {
			var l1 = $("#lastDiv").offset();
