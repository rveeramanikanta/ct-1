				...
				<div class="col-xs-12 border" id="animationArea">
					...
					<div class="col-xs-12 opacity00" id="totalElementsDiv">
						...
						<div class="col-xs-7" style="margin-top: 40px;">
							<div class="col-xs-12">
								<div class="col-xs-3">
									<div class="text-center padding0" id="xEqual">x</div>
									<div class="box-border value-center text-center numbers" id="xBox"></div>
								</div>
								<div class="col-xs-3">
									<div class="text-center padding0" id="temp">temp</div>
									<div class="box-border value-center text-center">
										<span class="numbers" id="tempDiv"></span>
									</div>
								</div>
								<div class="col-xs-3" id="q">
									<div class="text-center padding0">q</div>
									<div class="box-border value-center text-center">
...
$(document).ready(function() {
		...
		intro.onafterchange(function(targetElement) {
			...
			switch (elementId) {
						...
						switch(animateStep) {
							case "createMethod" :
								...
								$("#methodId").append('<div class="opacity00" id="createMethodId"><pre>node create(node first) {<br/>'
										...
										+ '<span id="ifConditionId">&emsp;<span id= "line23">if (<span id="flipxinIf" style="display:inline-block;">x</span> == -1) {</span><br/>'
										+ '&emsp;&emsp;<span id= "line24">return first</span><br/>'
										+ '&emsp;<span id= "line25">}</span></span>'
										+ '<div id="whileLoop" style="display: inline-block;">&emsp;' 
											+ '<span class="whileClass" id= "line5">while(<span id= "flipX" style="display: inline-block;">x</span> != -1) {</span><br/>'
										+ '&emsp;&emsp;<span class="whileClass" id= "line6">temp = (struct list*)malloc(sizeof(struct list));</span><br/>'
										+ '&emsp;&emsp;<span class="whileClass" id= "line7">temp->prev = NULL;</span><br/>'
										+ '&emsp;&emsp;<span class="whileClass" id= "line8">temp->info = ' 
										+ '<span id="flipX1" style="display: inline-block;">x</span>;</span><br/>'
										+ '&emsp;&emsp;<span class="whileClass" id= "line9">temp->next = NULL;</span><br/>'
										+ '&emsp;&emsp;<span class="whileClass" id= "line10">if (' 
											+ '<span id="firstValue" style="display:inline-block;">first</span> == NULL) {</span><br/>'
										+ '&emsp;&emsp;&emsp;<span class="whileClass" id= "line11">first = temp;</span><br/>'
										+ '&emsp;&emsp;<span class="whileClass" id= "line12">} else {</span><br/>'
										+ '&emsp;&emsp;&emsp;<span class="whileClass" id= "line13" style="display:inline-block;">q->next = temp;</span><br/>'
										+ '&emsp;&emsp;&emsp;<span class="whileClass" id= "line14" style="display:inline-block;">temp->prev = q;</span><br/>'
										+ '&emsp;&emsp;<span class="whileClass" id= "line15">}</span><br/>'
										+ '&emsp;&emsp;<span class="whileClass" id= "line16" style="display:inline-block">q = temp;</span><br/>'
										+ '&emsp;&emsp;<span class="whileClass" id= "line17">printf("Enter element:");</span><br/>'
										+ '&emsp;&emsp;<span class="whileClass" id= "line18">scanf("%d", &x);</span><br/>'
										+ '&emsp;<span class="whileClass" id= "line19">}</span></div><br/>'
										+ '&emsp;<span id= "line20">first->prev = q;</span><br/>'
										+ '&emsp;<span id= "line21">q->next = first;</span><br/>'
										+ '&emsp;<span id= "line22">return first;</span><br/>'
									+ '}</pre></div>');
								intro.refresh();
								$(".input-btn").remove();
								$(".introjs-helperLayer").one('transitionend', function() {
							...
							case "insertAtBeginMethod" :
								console.log("fddf");
								$("#methodId").empty();
								$("#methodId").append('<div class="opacity00" id="insertAtBeginMethodId">node inbegin(node first) {<br/>'
										...
										+ '<div id="ifCondition">&emsp;<span class="ifClass" id= "line8">if(<span class ="display-inline-css" id="flipFirst1">first</span> == NULL) {</span><br/>'
										+ '&emsp;&emsp;<span class="ifClass" id= "line9">first = temp;</span><br/>'
										+ '&emsp;<span id= "line10"><span class="ifClass">}</span> <span class="elseClass">else {</span></span><br/>'
										+ '&emsp;&emsp;<span class="elseClass whileLoopClass" id= "line11">while (' 
												+ '<span class="display-inline-css" id="qNextFlip">q->next</span>' 
												+ ' != <span class="display-inline-css" id="flipFirst2">first</span>) {</span><br/>'
										+ '&emsp;&emsp;&emsp;<span class="elseClass whileLoopClass" id= "line12">q = q->next;</span><br>'
										+ '&emsp;&emsp;<span class="elseClass whileLoopClass">}</span><br>' 
										+ '&emsp;&emsp;<span class="elseClass" id= "line13">temp->next = first;</span><br>'
										+ '&emsp;&emsp;<span class="elseClass" id= "line14">q->next = temp;</span><br>'
										+ '&emsp;&emsp;<span class="elseClass" id= "line15">temp->prev = q;</span><br>'
										+ '&emsp;&emsp;<span class="elseClass" id= "line16">first->prev = temp;</span><br>'
										+ '&emsp;&emsp;<span class="elseClass" id= "line17">first = temp;</span><br>'
										+ '&emsp;<span class="elseClass" id= "line18">}</span></div>'
										+ '&emsp;<span id= "line19">return first;</span><br/>'
										+ '<span>}</span></div>');
								intro.refresh();
								$(".input-btn").remove();
							...
							case "insertAtPositionMethod":
								...
								TweenMax.to($("#insertAtPositionMethodId"), 1, {opacity: 1, onComplete: function() {
									...
									$("#formId").append('<button type="button" id="insertAtpositionInputBtn" class="btn btn-success btn-sm input-btn">' 
												+ 'insert</button>');
									$("#q").after('<div class="col-xs-3" id="pDiv">' 
											+ '<div class="text-center padding0 numbers">p</div>'
											+ '<div class="box-border value-center text-center">'
							...
							case "insertAtEndMethod":
								...
								$("#methodId").append('<div class="opacity00" id="insertAtEndMethodId"><pre>node insertAtEnd(node first) {<br/>'
										+ '&emsp;<span id= "line1">node temp, q = first;</span><br/>'
										+ '&emsp;<span id= "line2">int x;</span><br/>'
										+ '<span id="insertEndifCondition">&emsp;<span class="ifClass" id= "line3">if (<span id="flipQ" class="display-inline-block;">q</span> == NULL) {</span><br/>'
										+ '&emsp;&emsp;<span class="ifClass" id= "line4">first = inbegin(first);</span><br/>'
										+ '&emsp;<span id= "line5"><span class="ifClass">}</span> <span class="elseClass" id= "lineNo5">else {</span></span><br/>'
										+ '&emsp;&emsp;<span class="elseClass" id= "line6">while(<span class="display-inline-css" id="qNext">q->next</span> != <span class="display-inline-css" id="flipFirst">first</span>) {</span><br/>'
										+ '&emsp;&emsp;&emsp;<span class="elseClass" id= "line7">q = q->next;</span><br/>'
										+ '&emsp;&emsp;<span class="elseClass" id= "line8">}</span><br/>'
										+ '&emsp;&emsp;<span class="elseClass" id= "line9">temp = (node)malloc(sizeof(struct list));</span><br/>'
										+ '&emsp;&emsp;<span class="elseClass" id= "line10">printf("Enter a value:");</span><br/>'
										+ '&emsp;&emsp;<span class="elseClass" id= "line11">scanf("%d", &x);</span><br/>'
										+ '&emsp;&emsp;<span class="elseClass" id= "line12">temp->info = x;</span><br/>'
										+ '&emsp;&emsp;<span class="elseClass" id= "line13">temp->next = temp->prev = NULL;</span><br/>'
										+ '&emsp;&emsp;<span class="elseClass" id= "line14">q->next = temp;</span><br/>'
										+ '&emsp;&emsp;<span class="elseClass" id= "line15">temp->next = first;</span><br/>'
										+ '&emsp;&emsp;<span class="elseClass" id= "line16">first->prev = temp;</span><br/>'
										+ '&emsp;&emsp;<span class="elseClass" id= "line17">temp->prev = q;</span><br/>'
										+ '&emsp;<span class="elseClass" id= "line18">}</span></span><br/>'
										+ '&emsp;<span id= "line19">return first;</span><br/>'
										+ '<span id="line20">}</span></pre></div>');
								intro.refresh();
								TweenMax.to($("#insertAtEndMethodId"), 1, {opacity: 1, onComplete: function() {
									$(".input-btn").remove();
									$("#innerHeading").text("Insert At End :");
							...
							case "deleteAtBeginMethod":
								...
								$("#methodId").append('<div class="opacity00" id="deleteAtBeginMethodId"><pre>node deleteAtBegin(node first) {<br/>'
									+ '&emsp;<span id="line1">node <span id="line1AssignValue">temp = first, q = first;</span></span><br/>'
									...
									+ '&emsp;&emsp;<span id="line5">while (q->next != first) {</span><br/>'
									+ '&emsp;&emsp;&emsp;<span id="line6">q = q->next;</span><br/>'
									+ '&emsp;&emsp;<span id="line7">}</span><br/>'
									+ '&emsp;&emsp;<span id="line8" style="display:inline-block;">first = <span style="display: inline-block">first->next</span>;</span><br/>'
									+ '&emsp;&emsp;<span id="line9" style="display:inline-block;">q->next=first;</span><br/>'
									+ '&emsp;&emsp;<span id="line10" style="display:inline-block;">first->prev = q;</span><br/>'
									+ '&emsp;&emsp;<span id="line11" style="display:inline-block;">free(temp);</span><br/>' 
									+ '&emsp;<span id="line12">}</span><br/>' 
									+ '&emsp;<span id="line13">return first;</span></br>' 
									+ '<span id="line14">}</span></pre></div>');
								intro.refresh();
							...
							case "deleteAtEndMethod":
								...
								$("#methodId").append('<div class="opacity00" id="deleteAtEndMethodId"><pre>node deleteAtEnd(node first) {<br/>' 
										...
										+ '&emsp;<span id="line4">} else if (q->next == first) {</span><br/>'
										+ '&emsp;&emsp;<span id="line5">first = delbegin(q);</span><br/>' 
										+ '&emsp;<span id="line6">} else {</span><br/>'
										+ '&emsp;&emsp;<span id="line7">while (q->next != first) {</span><br/>' 
										...
										+ '&emsp;&emsp;<span id="line13">free(q);</span><br/>' 
							...
							case "displayMethod":
								...
								$("#methodId").append('<div class="opacity00" id="displayMethodId"><pre>void display(node first) {<br/>'
									 ...
									 + '&emsp;&emsp;<span id="line6">while(q != first) {</span><br/>'
					...
					$(".introjs-helperLayer").one('transitionend', function() {
						...
						switch(animateStep) {
							case "createAnimation":
								var ramdomAddress = getRandomInt(1000, 5000);
								$("#ifConditionId").addClass("z-index-class");
								...
								$("#dynamicNodesDiv").append('<div class="col-xs-2 node opacity00" id="node' + count +'" style="top: 0px; width: auto;">'
										...
										+ '<div class="col-xs-4 no-border right-radius">' 
										+ '<span class="next-address" id="nextAddress' + count +'" style=""> ' + (ramdomAddress + 4) + '</span></div>'
										+ '</div></div>');
								intro.refresh();
								var text = "<span class='yellow-color' id='createWhileLoop'></span><br><span id='textforConditions'></span>"; 
								typing(".introjs-tooltiptext", text, function() {
									fromEffect("#createWhileLoop", "#ifConditionId", function() {
										$("#ifConditionId").removeClass("z-index-class");
										$(".introjs-tooltiptext #line23").effect("highlight", {color : "yellow"}, 1000, function() {
											flipEffect("#createWhileLoop #flipxinIf", $("#xBox").text(), function() {
												if ($("#xBox").text() == -1) {
													$(".introjs-tooltiptext #line24").effect("highlight", {color : "yellow"}, 1000, function() {
														$(".introjs-nextbutton").show();
													});
												} else {
													var text = "<ul><li>This condition evaluates to <span class='yellow-color'>false</span>.</li></ul>";
													typing("#textforConditions", text, function() {
														$(".introjs-tooltiptext #ifConditionId").removeClass("white-color");
														$("#totalElementsDiv").removeClass("opacity00");
														$(".introjs-tooltipbuttons").append("<a class='introjs-button nextButton' onclick = 'valueNotNull();'>Next &#8594;</a>");
													});
												}
											});
										});
								...
								break;
							case "createLine20Animation":
								$("#lastDiv").effect("highlight", {"color" : "yellow"}, function() {
									fromEffectWithOnlyText("#prev0", "#lastDiv", function() {
										var text = "345";
										typing(".introjs-tooltiptext", text, function() {
											$(".introjs-nextbutton").show();
										});
								...
								break;
							case "createLine21Animation":
								$("#firstDiv").effect("highlight", {"color" : "yellow"}, function() {
									$("#next" + count - 1).addClass("z-index-transfer yellow-color");
									fromEffectWithOnlyText("#next" + (count - 1), "#firstDiv", function() {
							...
							case "insertAtBeginAnimation":
								...
								typing(".introjs-tooltiptext", text, function() {
									$("#line1").effect("highight", {"color" : "yellow"}, function() {
										$("#firstDiv").effect("highlight", {"color" : "yellow"}, function() {
											fromEffectWithOnlyText("#lastDiv", "#firstDiv", function() {
												$("#createNode").addClass("z-index-transfer yellow-color");
												fromEffect("#createNode","#line3", function() {
							...
							case "insertAtBeginAfterTakingValueAnimation":
								$(".nextButton").remove();
								var text = "<span class='yellow-color' id='xValue'></span></br><span id='xValueText'></span>";
								typing(".introjs-tooltiptext", text, function() {
									$("#line6").effect("highlight",{color: 'yellow'}, 1500, function() {
										fromEffect("#xValue", "#line6", function() {
											var text1 = "This statement is used to create a new node dynamically.";
											typing("#xValueText", text1, function() {
												...
												fromEffectWithOnlyText("#info0", "#xBox", function() {
													...
													$(".introjs-tooltipbuttons").append("<a class='introjs-button nextButton' onclick = 'insertAtBeginXValue();'>Next &#8594;</a>");
												});
											});
										});
									});
							...
							case "insertAtEndAnimation":
								...
								$("#line1").effect("highlight",{color: 'yellow'}, 1500, function() {
									...
									fromEffectWithOnlyText("#lastDiv", "#firstDiv", function() {
										$("#lastDiv").removeClass("z-index-transfer yellow-color");
										var text = "<span class='yellow-color' id='ifCond'></span></br><span id='ifCondText'></span>";
										typing(".introjs-tooltiptext", text, function() {
											fromEffect("#ifCond", "#insertEndifCondition", function() {
												$("#line3").effect("highlight",{color: 'yellow'}, 1500, function() {
													flipEffect("#ifCond #flipQ", $("#firstDiv").text() , function() {
														if ($("#firstDiv").text() == "NULL") {
															$("#ifCond .elseClass").addClass("white-color");
															$("#ifCond #line4").effect("highlight",{color: 'yellow'}, 1500, function() {
																$(".introjs-tooltipbuttons").append("<a class='introjs-button nextButton' onclick = 'insertAtBeginMethodDynamicSteps();'>Next &#8594;</a>");
															});
														} else {
															$("#ifCond .ifClass").addClass("white-color");
															$("#ifCond #line5").effect("highlight", {"color" : "yellow"}, function() {
																$(".introjs-tooltipbuttons").append("<a class='introjs-button nextButton' onclick = 'insertAtEndLoopAnimation(0);'>Next &#8594;</a>");
																/* $("#ifCond #line6").effect("highlight", {"color" : "yellow"}, function() {
																	flipEffect("#ifCond #qNext", "23" , function() {
																		flipEffect("#ifCond #flipFirst", $("#firstDiv").text(), function() {
																			//if ($("#lastDiv").text() != $("#firstDiv").text()) {
																				console.log("if condition to check");
																				$(".introjs-tooltipbuttons").append("<a class='introjs-button nextButton' onclick = 'insertAtEndLoopAnimation(0);'>Next &#8594;</a>");
																			//} else {
																				console.log("else condition to check");
																				//$(".introjs-nextbutton").show();
																			//}
																		});
																	});
							...
							case "insertAtEndRemainingAnimation":
									...
									typing(".introjs-tooltiptext", text, function() {
										...
										TweenMax.to("#xValue", 1, {top : 0,left : 0, onComplete:function() {
											...
											typing("#xValueText", text1, function() {
												...
												var l1 = $("#xBox").offset();
												$("#info" + (count - 1)).text($("#xBox").text()).removeClass("visibility-hidden").offset({
													"top":l1.top,
													"left":l1.left
												});
												$("#info" + (count - 1)).addClass("z-index-transfer yellow-color");
												TweenMax.to("#info" + (count - 1),1 , {top : 0, left : 0, onComplete:function() {
													$("#info" + (count - 1)).removeClass("z-index-transfer yellow-color");
													$("#line13").effect("highlight",{color: 'yellow'}, 1000, function() {
														typing(".introjs-tooltiptext", text, function() {
															$("#xValue").addClass("z-index-transfer yellow-color");
															fromEffect("#xValue", "#line13", function() {
																$("#xValue").removeClass("z-index-transfer yellow-color");
																var text1 = "This statement will store x value in info of temp.";
																typing("#xValueText", text1, function() {
																	console.log("count value before line 14 ------" + count);
																	$("#prev" + count).text("NULL");
																	$("#prev" + count).removeClass("visibility-hidden");
																	console.log("count value prev visibility ------" + count);
																	$("#next" + count).text("NULL");
																	$("#next" + count).removeClass("visibility-hidden");
																	console.log("count value next visibility ------" + count);
																	$(".introjs-tooltipbuttons").append("<a class='introjs-button nextButton' onclick = 'remainingStmtsOfInsertAtEnd();'>Next &#8594;</a>");
																});
															});
														});
													});
								...
								$("#xValue").addClass("z-index-transfer yellow-color");
								/* fromEffect("#xValue", "#line14", function() {
								...
								TweenMax.to("#xValue", 1, {top : 0,left : 0, onComplete : function() {
									...
									typing("#xValueText", text1, function() {
										...
										$("#next"  + (count - 1)).addClass("z-index-transfer yellow-color");
										fromEffectWithOnlyText("#next" + (count - 2), "#tempDiv", function() {
											$("#next"  + (count - 2)).removeClass("z-index-transfer yellow-color");
											rightToLeftArrow("#animationDiv", "#nextDiv" + (count - 2), "#prevDiv" + (count - 1), "#svgId", "rightLines" + arrowCount, "arrow", function() {
												//bring stmt
												$("#prevAddress0").effect("highlight", {"color" : "yellow"}, function() {
													//bring stmt
													fromEffectWithOnlyText("#next" + (count - 1), "#prevAddress0", function() {
														$("#tempDiv").effect("highlight", {"color" : "yellow"}, function() {
															fromEffectWithOnlyText("#prev0", "#tempDiv", function() {
																		...
																		TweenMax.to("#xValue",1,{top:0,left:0, onComplete:function() {	
																			...
																			typing("#xValueText", text1, function() {
																				...
																				TweenMax.to("#prev" + count,1,{top:0,left:0, onComplete:function() {
																					...
																					leftToRightArrow($("#animationDiv"),  $("#prevDiv" + (count - 1)), $("#nextDiv" + (count - 2)) , "#svgId", "leftLines" + arrowCount, "arrow", function() {
																						regenerateArrows();
																						arrowCount++;
																						count++;
																						$('.introjs-nextbutton').show();
									...
									TweenMax.to("#lastDiv", 1,{top:0,left:0, onComplete:function() {
										...
										$("#line2").effect( "highlight",{color: 'yellow'}, 1000 ,function() {
											if ($("#lastDiv").text() == "NULL") {
												...
												$("#line5").effect( "highlight",{color: 'yellow'}, 1000 ,function() {
									...
									TweenMax.to("#lastDiv", 1,{top:0,left:0, onComplete:function() {
										...
										$("#line2").effect( "highlight",{color: 'yellow'}, 1000 ,function() {
											...
											if ($("#lastDiv").text() == "NULL") {
												...
												$("#line4").effect( "highlight",{color: 'yellow'}, 1000 ,function() {
													$("#line5").effect( "highlight",{color: 'yellow'}, 1000 ,function() {
														deleteAtBeginMethodDynamicSteps();
													});
												});
				...
				case "line20":
					...
					$(".introjs-helperLayer").one('transitionend', function() {
						$("#whileLoop").removeClass("z-index-class");
						$("#line20").effect("highlight", {"color" : "yellow"}, function() {
							var text = "Here it will return first to the next method.";
							typing(".introjs-tooltiptext", text, function() {
								//$(".introjs-tooltipbuttons").append("<a class='introjs-button nextButton' onclick = 'createstoringCircularAddress();'>Next &#8594;</a>");
								$('.introjs-nextbutton').show();
							});
						});
					});
				...
				case "line21":
					$('.introjs-nextbutton').hide();
					$(".introjs-helperLayer").one('transitionend', function() {
						$("#line21").effect("highlight", {"color" : "yellow"}, function() {
							var text = "Here it will return first to the next method.";
							typing(".introjs-tooltiptext", text, function() {
								//$(".introjs-tooltipbuttons").append("<a class='introjs-button nextButton' onclick = 'createstoringCircularAddress();'>Next &#8594;</a>");
								$('.introjs-nextbutton').show();
				...
				case "line22":
					$('.introjs-nextbutton').hide();
					$(".introjs-helperLayer").one('transitionend', function() {
						$("#line22").effect("highlight", {"color" : "yellow"}, function() {
							var text = "Here it will return first to the next method.";
							typing(".introjs-tooltiptext", text, function() {
								//$(".introjs-tooltipbuttons").append("<a class='introjs-button nextButton' onclick = 'createstoringCircularAddress();'>Next &#8594;</a>");
								$('.introjs-nextbutton').show();
	...
	function repeatDynamicStepsForCreate() {
		...
		if ($("#inputIdField").val() != -1) {
			...
			var options = {
				...
				intro : '',
				position : 'bottom',
				animateStep : "createLine20Animation"
			}
			intro.insertOption(intro._currentStep + ++steps, options);
			...
			var options = {
				...
				intro : '',
				position : 'bottom',
				animateStep : "createLine21Animation"
			}
			intro.insertOption(intro._currentStep + ++steps, options);
	...
	function valueNotNull() {
		$("#textforConditions").text("");
		$(".nextButton").remove();
		$("#whileLoop").addClass("z-index-class");
		fromEffect("#createWhileLoop", "#whileLoop", function() {
			$("#whileLoop").removeClass("z-index-class");
			$(".introjs-tooltiptext #line5").effect("highlight", {color: 'yellow'}, 1500, function() {
				flipEffect("#createWhileLoop > #flipX", $("#xBox").text(), function() {
					if ($("#xBox").text() != -1) {
						$(".introjs-tooltiptext #line6").effect("highlight",{color: 'yellow'}, 1500, function() {
							...
							TweenMax.from($("#node" + count), 1, {top: -100, onComplete:function() {
								$("#prevAddress" + count).effect("highlight",{color: 'yellow'}, 1500, function() {
									$("#lastDiv").addClass("z-index-transfer yellow-color");
									fromEffectWithOnlyText("#tempDiv", "#prevAddress" + count, function() {
										$("#lastDiv").removeClass("z-index-transfer yellow-color");
	...
	function createremainingAnimation() {
		$(".nextButton").remove();
		$("#createWhileLoop #line16").effect("highlight",{color: 'yellow'}, 1500, function() {
			$("#lastDiv").addClass("z-index-transfer yellow-color");
			fromEffect("#lastDiv", "#tempDiv", function() {
				$("#lastDiv").removeClass("z-index-transfer yellow-color");
				$("#createWhileLoop #line17").effect("highlight",{color: 'yellow'}, 1500, function() {
					count++;
					$('.introjs-nextbutton').show();
				});
			});
	...
	function createstoringCircularAddress() {
		$(".nextButton").remove();
		$("#line21").effect("highlight", {"color" : "yellow"}, function() {
	...
	function insertAtEndLoopAnimation(i) {
		$(".nextButton").remove();
	console.log("insert at end loop animaination");
		var ramdomAddress = getRandomInt(1000, 5000);
		/* var text = "<span id='ifCond'></span></br><span id='ifCondText'></span>";
		$("#line6").effect("highlight",{color: 'yellow'}, 1500, function() {
			typing(".introjs-tooltiptext", text, function() {
				...
				TweenMax.to("#ifCond",1,{top:0,left:0, onComplete:function() {
					$("#ifCond").removeClass("z-index-transfer"); */
					if (i < count) {
						console.log("i value to know" + i);
						if ($("#lastDiv").text() != "NULL") {
						//f ($("#lastDiv").text() != $("#prevAddress0").text()) {
							$("#ifCond #line7").effect("highlight",{color: 'yellow'}, 1500, function() {
								/* typing(".introjs-tooltiptext", text, function() {
									var l1 = $("#line7").offset();
									...
									TweenMax.to("#ifCond",1,{top:0,left:0, onComplete:function() {
										$("#ifCond").removeClass("z-index-transfer"); */
										$("#lastDiv").addClass("z-index-transfer yellow-color");
										fromEffectWithOnlyText("#lastDiv", "#prevAddress" + i, function() {
											$("#lastDiv").removeClass("z-index-transfer yellow-color");
											i++;
						...
						$("#ifCond #line9").effect("highlight",{color: 'yellow'}, 1500, function() {
							/* typing(".introjs-tooltiptext", text, function() {
								var l1 = $("#line9").offset();
								...
								TweenMax.to("#ifCond",1,{top:0,left:0, onComplete:function() {
									...
									TweenMax.from("#node" + count, 1, {top: -100, onComplete:function() {
										...
										fromEffectWithOnlyText("#tempDiv", "#prevAddress" + count, function() {
											$("#tempDiv").removeClass("z-index-transfer yellow-color");
											$("#ifCond #line10").effect("highlight",{color: 'yellow'}, 1500, function() {
												count++;
												$('.introjs-nextbutton').show();
											});
										});
			...
			$("#line8").effect("highlight",{color: 'yellow'}, 2000 ,function() {
				if (node < (count - 1)) {
					...
					$("#line11").effect( "highlight",{color: 'yellow'}, 1000 ,function() {
						$("#firstDiv").effect( "highlight",{color: 'yellow'}, 1000 ,function() {
							fromEffectWithOnlyText("#next" + (count - 2), "#firstDiv", function() {
								//$("#next" + (count - 2)).text("NULL");
								$("#line12").effect( "highlight",{color: 'yellow'}, 1000 ,function() {
									fromEffectWithOnlyText("#prev0", "#prevAddress" + (count - 2), function() {
										$("#line13").effect( "highlight",{color: 'yellow'}, 1000 ,function() {
											$("#dynamicNodesDiv > div:last-child").effect( "highlight",{color: 'red'}, 1000 ,function() {
	...
	function fromEffect(id1, id2, callBackFunction) {
		var l1 = $(id2).offset();
		$(id1).html($(id2).html()).removeClass("visibility-hidden").offset({
			"top" : l1.top,
			"left" : l1.left
		});
	...
	function fromEffectWithOnlyText(id1, id2, callBackFunction) {
		var l1 = $(id2).offset();
		$(id1).text($(id2).text()).removeClass("visibility-hidden").offset({
			"top" : l1.top,
			"left" : l1.left
		});
		TweenMax.to(id1, 0.5, {top : 0, left : 0, onComplete: function() {
	...
	function createMethodSecondStep() {
		$(".nextButton").remove();
		$(".introjs-tooltiptext #line7").effect("highlight",{color: 'yellow'}, 1500, function() {
			$("#prev" + count).text("NULL").removeClass("visibility-hidden");
			$(".introjs-tooltiptext #line8").effect("highlight",{color: 'yellow'}, 1500, function() {
				flipEffect("#createWhileLoopContent1 > #flipX1", $("#xBox").text() , function() {
					$("#info" + count).addClass("z-index-transfer yellow-color");
					fromEffectWithOnlyText("#info" + count, "#xBox", function() {
						$("#info" + count).removeClass("z-index-transfer yellow-color");
						$(".introjs-tooltiptext #line9").effect("highlight",{color: 'yellow'}, 1500, function() {
	...
	function createMethodThirdStep() {
		$(".nextButton").remove();
		$(".introjs-tooltiptext #line10").effect("highlight",{color: 'yellow'}, 1500, function() {
			flipEffect("#createWhileLoop  #firstValue", $("#firstDiv").text() , function() {
				if ($("#firstDiv").text() == "NULL") {
					$(".introjs-tooltiptext #line11").effect("highlight",{color: 'yellow'}, 1500, function() {
					...
					$(".introjs-tooltiptext #line12").effect("highlight",{color: 'yellow'}, 1500, function() {
						$(".introjs-tooltiptext #line13").effect("highlight",{color: 'yellow'}, 1500, function() {
							fromEffectWithOnlyText("#next" + (count - 1), "#tempDiv", function() {
								rightToLeftArrow("#animationDiv", "#nextDiv" + (count-1), "#prevDiv" + count, "#svgId", "rightLines" + arrowCount, "arrow", function() {
									$(".introjs-tooltiptext #line14").effect("highlight",{color: 'yellow'}, 1500, function() {
										fromEffectWithOnlyText("#prev" + count, "#lastDiv", function() {
	...
	function insertAtBeginXValue() {
		$(".nextButton").remove();
		$("#line7").effect("highlight", {color: 'yellow'}, 1500, function() {
			fromEffect("#xValue", "#line7", function() {
				$("#xValue").addClass("z-index-transfer yellow-color");
				$("#xValue").removeClass("z-index-transfer");
				var text1 = "This statement is used to store x value in the node.";
				typing("#xValueText", text1, function() {
					$("#xValueText").text("");
					fromEffect("#xValue" ,"#ifCondition", function() {
						$(".introjs-tooltiptext #line8").effect("highlight", {"color" : "yellow"}, function() {
							flipEffect(".introjs-tooltiptext #flipFirst1", $("#firstDiv").text(), function() {
								/* *********** */
	...
	function insertBeginFirstStep() {
		...
		if ($("#firstDiv").text() == "NULL") {
			$(".introjs-tooltiptext #line9").effect("highlight",{color: 'yellow'}, 1500, function() {
				$("#tempDiv").effect("highlight", {"color" : "yellow"}, function() {
					fromEffect("#firstDiv", "#tempDiv", function() {
						svgAnimatingLineSelector1RightSideToSelector2LeftSide("#animationDiv", "#first", "#prevDiv" + count, "#svgId", "startLine" + arrowCount, "arrow", function() {
							$("#startLine" + arrowCount).addClass("start-arrow");
							$(".introjs-tooltipbuttons").append("<a class='introjs-button nextButton' onclick = 'insertAtBeginMoveAddresses()'>Next &#8594;</a>");
							arrowCount++;
							count++;
							regenerateArrows();
						});
			...
			$(".introjs-tooltiptext #line10").effect("highlight",{color: 'yellow'}, 1500, function() {
				...
				$(".introjs-tooltiptext #line11").effect("highlight", {"color" : "yellow"}, function() {
					flipEffect(".introjs-tooltiptext #qNextFlip", $("#next0").text(), function() {
						flipEffect(".introjs-tooltiptext #flipFirst2", $("#firstDiv").text(), function() {	
							insertBeginWhileLoop(1);
						});
					});
				});
			});
	...
	function insertBeginWhileLoop(i) {
		if (i <= count) {
			console.log("i value ------  " + i)
			if ($("#firstDiv").text() == $("#next" + i).text()) {
				insertAtBeginMoveAddresses();
			} else {
				i++;
				$(".introjs-tooltiptext #line12").effect("highlight", {"color" : "yellow"}, function() {
					fromEffectWithOnlyText("#lastDiv", "#next" + i, function() {
						$(".introjs-tooltiptext #line11").effect("highlight", {"color" : "yellow"}, function() {
							flipEffect(".introjs-tooltiptext #qNextFlip", $("#next" + i).text(), function() {
								insertBeginWhileLoop (i);
							});
						});
					});
				});
	...
	function insertAtBeginMoveAddresses() {
		$(".nextButton").remove();
		$(".introjs-tooltiptext #line13").effect("highlight", {"color" : "yellow"}, function() {
			$("#whileLoop").removeClass("z-index-class");
			$("#insertAtBeginMethodId").removeClass("z-index-class");
			//arrows
			fromEffectWithOnlyText("#next0", "#firstDiv", function() {
				$(".introjs-tooltiptext #line14").effect("highlight", {"color" : "yellow"}, function() {
					fromEffectWithOnlyText("#next" + count, "#tempDiv", function() {
						$(".introjs-tooltiptext #line15").effect("highlight", {"color" : "yellow"}, function() {
						//arrows	
							
							fromEffectWithOnlyText("#prev0", "#lastDiv", function() {
								$(".introjs-tooltiptext #line16").effect("highlight", {"color" : "yellow"}, function() {
									fromEffectWithOnlyText("#prev1", "#tempDiv", function() {
										$(".introjs-tooltiptext #line17").effect("highlight", {"color" : "yellow"}, function() {
											fromEffectWithOnlyText("#firstDiv", "#tempDiv", function() {
												//$("#whileLoop").removeClass("z-index-class");
	...
	function insertPositionRemainingThirdStep() {
		...
		$("#line22").effect("highlight",{color: 'yellow'}, 1500, function() {
			...
			TweenMax.to("#prev" + (position - 1), 1, {top : 0, left : 0, onComplete:function() {
				$("#prev" + (position - 1)).removeClass("z-index-transfer yellow-color");
				$("#line24").effect("highlight",{color: 'yellow'}, 1000, function() {
					changeIds();
					arrowCount++;
					count++;
					regenerateArrows();
	...
	function remainingStmtsOfInsertAtEnd() {
		$(".nextButton").remove();
		$("#line14").effect("highlight",{color: 'yellow'}, 1000, function() {
			$("#xValue").addClass("z-index-transfer yellow-color");
			fromEffect("#xValue", "#line14", function() {
				$("#xValue").removeClass("z-index-transfer yellow-color");
				$("#next" + (count - 2)).addClass("z-index-transfer yellow-color");
				$("#tempDiv").effect("highlight",{color: 'yellow'}, 1000, function() {
					fromEffectWithOnlyText("#next" + (count - 2), "#tempDiv", function() {
						$("#next" + (count - 2)).removeClass("z-index-transfer yellow-color");
						$(".introjs-tooltipbuttons").append("<a class='introjs-button nextButton' onclick = 'insertAtEndStmt15();'>Next &#8594;</a>");
					});
				});
			});
		});
	...
	function insertAtEndStmt15() {
		$(".nextButton").remove();
		$("#line15").effect("highlight", {"color" : "yellow"}, function() {
			$("#xValue").addClass("z-index-transfer yellow-color");
			fromEffect("#xValue", "#line15", function() {
				$("#xValue").removeClass("z-index-transfer yellow-color");
				$("#tempDiv").effect("highlight",{color: 'yellow'}, 1000, function() {
					fromEffectWithOnlyText("#next" + (count - 1), "#firstDiv", function() {
						$("#next" + (count - 2)).removeClass("z-index-transfer yellow-color");
						$(".introjs-tooltipbuttons").append("<a class='introjs-button nextButton' onclick = 'insertAtEndStmt16();'>Next &#8594;</a>");
					});
				});
			});
		});
	...
	function insertAtEndStmt16() {
		$(".nextButton").remove();
		$("#line16").effect("highlight", {"color" : "yellow"}, function() {
			$("#xValue").addClass("z-index-transfer yellow-color");
			fromEffect("#xValue", "#line16", function() {
				$("#xValue").removeClass("z-index-transfer yellow-color");
				$("#tempDiv").effect("highlight",{color: 'yellow'}, 1000, function() {
					fromEffectWithOnlyText("#prev0", "#tempDiv", function() {
						$("#next" + (count - 2)).removeClass("z-index-transfer yellow-color");
	...
	function insertAtEndStmt17() {
		$(".nextButton").remove();
		$("#line17").effect("highlight", {"color" : "yellow"}, function() {
			$("#xValue").addClass("z-index-transfer yellow-color");
			fromEffect("#xValue", "#line17", function() {
				$("#xValue").removeClass("z-index-transfer yellow-color");
				$("#tempDiv").effect("highlight",{color: 'yellow'}, 1000, function() {
					fromEffectWithOnlyText("#prev0", "#lastDiv", function() {
						$("#next" + (count - 2)).removeClass("z-index-transfer yellow-color");
