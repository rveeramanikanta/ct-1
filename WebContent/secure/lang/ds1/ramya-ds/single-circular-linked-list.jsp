...
<title>single circular linkedlist</title>
<style type="text/css">
						...
						switch(animateStep) {
							case "createMethod" :
								...
								$("#methodId").append('<div class="opacity00" id="createMethodId"><pre>node create(node first) {</br>'
									  ...
									  + '<div id="whileLoop">&emsp;&emsp;<span id="line5">while (x != -1) {</span></br>'
								      ...
								      + '<span id = "totalIfId"	>&emsp;&emsp;<span id="line9">if (first == NULL)</span> {</br>'
	...
	function insertingElementAtBegining() {
		...
		typing(".introjs-tooltiptext", text, function() {
			...
			TweenMax.to("#line3MallocText",1,{top:0,left:0, onComplete:function() {
				typing("#explainMalloc", "This is used to create memory.", function() {
					$("#node0").removeClass("opacity00");
					TweenMax.from($("#node0"), 1, {top: -100, onComplete:function() {
						var l1 = $("#infoAddress0").offset();
						$("#tempDiv").empty("");
