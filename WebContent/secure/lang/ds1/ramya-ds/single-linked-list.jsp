						...
						switch(animateStep) {
							case "createMethod" :
								...
								$("#methodId").append('<div class="opacity00" id="createMethodId"><pre>node create(node first) {</br>'
								      ...
								      + '&emsp;<span id="line17">}</span></div></br>'
								...
								TweenMax.to($("#createMethodId"), 1, {opacity: 1, onComplete: function() {
									$("#totalElementsDiv, #ElementsDiv, #xEqual, #xBox, #q, #lastDiv,#temp, #tempDiv").removeClass("opacity00");
							...
							case "animationDiv4":
								$("#line1").effect("highlight",{color: 'yellow'}, 1500,function() {
									...
									TweenMax.to("#tempDiv",1,{top:0,left:0, onComplete:function() {
										var text = "<span id='line2IfId'></span><br><span id='line4elseIfId'></span><br>" 
											+ "<span id='line6elseId'></span><br><span id='line7WhileId'></span>" 
											+ "<br/><span id='pqTooltipId'></span><br/><span id='qNextTooltipId'></span>";
										typing(".introjs-tooltiptext", text, function() {
											var l1= $("#line2").offset();
											...
											TweenMax.to("#line2IfId",1,{top:0,left:0, onComplete:function() {
												if ($("#dynamicNodesDiv > div").length == 0) {
													//error
													var text = "<span class='yellow-color'>true</span><br/><span class='ct-code-b-red'>" 
														+ "There is no node to delete, please insert node to delete.</span>"
													typing(".introjs-tooltiptext", text, function() {
														$('.introjs-nextbutton').show();	
													});
